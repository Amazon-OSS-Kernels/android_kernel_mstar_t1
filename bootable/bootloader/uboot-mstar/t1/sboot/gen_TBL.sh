...
{
    sed -i  "s/#define OUTERSIZE.*/#define OUTERSIZE      $KSUM/g" src/drvLoadTbl.h


    v=$((${#ARRAY[@]}*512))
    val=$(printf "0x%x" $v)
    sed -i  "s/#define PAD_PRE_SECT_SIZE.*/#define PAD_PRE_SECT_SIZE      $val/g" src/drvLoadTbl.h
    v=$((${#ARRAY[@]}*1024))
    val=$(printf "0x%x" $v)
    sed -i  "s/#define PAD_SECT_SIZE.*/#define PAD_SECT_SIZE          $val/g" src/drvLoadTbl.h
    sed -i  "s/#define MIU0_SECT_SIZE.*/#define MIU0_SECT_SIZE         $val/g" src/drvLoadTbl.h
    sed -i  "s/#define MIU1_SECT_SIZE.*/#define MIU1_SECT_SIZE         $val/g" src/drvLoadTbl.h
    sed -i  "s/#define MIU2_SECT_SIZE.*/#define MIU2_SECT_SIZE         $val/g" src/drvLoadTbl.h
    sed -i  "s/#define MIU0_STR_SECT_SIZE.*/#define MIU0_STR_SECT_SIZE     $val/g" src/drvLoadTbl.h
    sed -i  "s/#define MIU1_STR_SECT_SIZE.*/#define MIU1_STR_SECT_SIZE     $val/g" src/drvLoadTbl.h
    sed -i  "s/#define MIU2_STR_SECT_SIZE.*/#define MIU2_STR_SECT_SIZE     $val/g" src/drvLoadTbl.h
    sed -i  "s/#define MIU0_RELOAD_SECT_SIZE.*/#define MIU0_RELOAD_SECT_SIZE     $val/g" src/drvLoadTbl.h
    sed -i  "s/#define MIU1_RELOAD_SECT_SIZE.*/#define MIU1_RELOAD_SECT_SIZE     $val/g" src/drvLoadTbl.h
    sed -i  "s/#define MIU2_RELOAD_SECT_SIZE.*/#define MIU2_RELOAD_SECT_SIZE     $val/g" src/drvLoadTbl.h
}
