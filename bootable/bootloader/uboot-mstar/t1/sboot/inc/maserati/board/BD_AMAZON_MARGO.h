...
#define BOARD_NAME                              "BD_AMAZON_MARGO"
...
#define PADS_I2S_IN_CFG                             ENABLE                 //Option: ENABLE / DISABLE
...
#define PADS_VSYNC_LIKE_CFG                     DISABLE                 //Option: CONFIG_PADMUX_MODE1 / CONFIG_PADMUX_MODE2 / CONFIG_PADMUX_MODE3 / DISABLE
...
//Panel
#define BALL_G5_IS_GPIO                         GPIO_OUT_HIGH             //PANEL_ON/OFF (Panel)     (Low: Off / High: On)
#define BALL_AE2_IS_GPIO                        GPIO_OUT_HIGH             //VBL_CTRL  (Backlight) (Low: On / High: Off)
//audio
#define BALL_B11_IS_GPIO                        GPIO_OUT_HIGH            //AMP-MUTE (Low: On / High: Mute)
#define BALL_B12_IS_GPIO                        GPIO_OUT_HIGH           //AMP-RESET (Low: Off / High: On)

//MHL
#define BALL_A10_IS_GPIO                        GPIO_IN                 //MHL_CABLE_DET

//USB
#define BALL_AR2_IS_GPIO                        GPIO_OUT_LOW           //USB3_EN (Low: Off / High: On)
//I2C
#define BALL_C16_IS_GPIO                        GPIO_IN                 //I2C-SCL (EEPROM)
#define BALL_B16_IS_GPIO                        GPIO_IN                 //I2C-SDA (EEPROM)
#define BALL_AK5_IS_GPIO                        GPIO_IN                 //T_SCL
#define BALL_AK6_IS_GPIO                        GPIO_IN                 //T_SCA
//#define BALL_K4_IS_GPIO                         GPIO_IN                 //HDMI1-SDA
//#define BALL_J5_IS_GPIO                         GPIO_IN                 //HDMI1-SCL
//#define BALL_M2_IS_GPIO                         GPIO_IN                 //HDMI2-SDA
//#define BALL_L3_IS_GPIO                         GPIO_IN                 //HDMI2-SCL
//#define BALL_L2_IS_GPIO                         GPIO_IN                 //HDMI3-SDA
//#define BALL_K3_IS_GPIO                         GPIO_IN                 //HDMI3-SCL

#define BALL_AJ6_IS_GPIO                        GPIO_IN                 //FRC_SCL
#define BALL_N4_IS_GPIO                         GPIO_IN                 //FRC_SDA
//LED
#define BALL_C10_IS_GPIO                        GPIO_OUT_LOW             //LED_R (Low: off / High: On)
#define BALL_C14_IS_GPIO			            GPIO_OUT_LOW              //LED_G (Low: off / High: On)

//SAR
//#define BALL_B1_IS_GPIO                         GPIO_IN                 //KEY0-in
#define BALL_H5_IS_GPIO                         GPIO_IN                 //EAR-PLUG
//POWER
//#define BALL_B4_IS_GPIO                         GPIO_IN                 //POWER_DETECT
//IR
#define BALL_F8_IS_GPIO                         GPIO_IN                 //IR-in
// 3D
#define BALL_A12_IS_GPIO                        GPIO_IN                 // 3D_EN
#define BALL_C15_IS_GPIO                        GPIO_OUT_HIGH           // LR_SYNC
#define BALL_AA6_IS_GPIO                        GPIO_OUT_HIGH           // 3D_LR_IN
//WAKE CONTROL
#define BALL_C11_IS_GPIO                        GPIO_IN                 // BT_HOST_WAKE
#define BALL_AA5_IS_GPIO                        GPIO_IN                 // WL_HOST_WAKE
#define BALL_E7_IS_GPIO                         GPIO_OUT_HIGH           // BT_REG_ON
#define BALL_F7_IS_GPIO                         GPIO_OUT_HIGH           // WIFI_REG_ON
//HDMI
#define BALL_L5_IS_GPIO                         GPIO_IN                 // HDMI1-HPD
#define BALL_K6_IS_GPIO                         GPIO_IN                 // HDMI2-HPD
#define BALL_H4_IS_GPIO                         GPIO_IN                 // HDMI3-HPD
//SD
#define BALL_R5_IS_GPIO                         GPIO_OUT_HIGH           //SD-WP
#define BALL_F5_IS_GPIO                         GPIO_IN                 //NAND_CLE
#define BALL_F4_IS_GPIO                         GPIO_IN                 //NAND_ALE
#define BALL_G6_IS_GPIO                         GPIO_IN                 //NAND_WPZ
#define BALL_F6_IS_GPIO                         GPIO_IN                 //NAND-WEZ
#define BALL_H6_IS_GPIO                         GPIO_IN                 //SDIO_CLK
#define BALL_E4_IS_GPIO                         GPIO_IN                 //NAND-CE1Z
#define BALL_R6_IS_GPIO                         GPIO_OUT_HIGH           //SD_CDZ
//I2S_AUBCK
#define BALL_F16_IS_GPIO                        GPIO_OUT_HIGH           //AUBCK_OUT
#define BALL_F15_IS_GPIO                        GPIO_OUT_HIGH           //AUMCK_OUT
#define BALL_E15_IS_GPIO                        GPIO_OUT_HIGH           //AUWS_OUT
#define BALL_D16_IS_GPIO                        GPIO_OUT_HIGH           //AUSD_OUT
//SPDEF
#define BALL_G14_IS_GPIO                        GPIO_OUT_HIGH           //SPDIF_OUT
//AV/YPbPr Detection
#define PAD_GPIO_PM6_IS_GPIO                    GPIO_IN
#define PAD_GPIO_PM10_IS_GPIO                   GPIO_IN
//engineering/production device detection
...
#define REG_USB30_PORT2_GPIO_OFFSET             0x20 //bit0~bit7 offset addr
...
#define Panel_Backlight_VCC_ON()                mdrv_gpio_set_low(BALL_AE2)
#define Panel_Backlight_VCC_OFF()               mdrv_gpio_set_high(BALL_AE2)
...
// LED Control
#define LED_RED_ON()                            mdrv_gpio_set_high(BALL_C10)
#define LED_RED_OFF()                           mdrv_gpio_set_low(BALL_C10)
#define LED_GREEN_ON()                          mdrv_gpio_set_high(BALL_C14)
#define LED_GREEN_OFF()                         mdrv_gpio_set_low(BALL_C14)
...
#define PWM0_PERIOD                           0xff      //PWM0_duty= ( PWM2_PERIOD+1 ) * (1/XTAL)
//#define PWM1_PERIOD                           0xff
//#define PWM2_PERIOD                             0xff
//#define PWM3_PERIOD                           0xff

#define INIT_PWM0_DUTY                        0x7e    //PWM0_duty= (Init_Pwm0_DUTY +1 ) * (1/XTAL)
