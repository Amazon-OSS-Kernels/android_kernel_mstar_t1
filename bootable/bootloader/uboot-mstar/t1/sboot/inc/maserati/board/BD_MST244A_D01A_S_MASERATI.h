...
#define BOARD_NAME                              "BD_MST244A_D01A_S_MASERATI"
...
//audio
#define BALL_C15_IS_GPIO                        GPIO_OUT_LOW            //AMP_EN (Low: On / High: Mute)
#define BALL_AH4_IS_GPIO                        GPIO_OUT_LOW            //AUMUTE_OUT (Low: On / High: Mute)
...
// Audio Amplifier
#define Audio_Amplifier_ON()                    mdrv_gpio_set_high(BALL_C15)
#define Audio_Amplifier_OFF()                   mdrv_gpio_set_low(BALL_C15)

#define Adj_Volume_On()                         mdrv_gpio_set_high(BALL_AH4)
#define Adj_Volume_Off()                        mdrv_gpio_set_low(BALL_AH4)
