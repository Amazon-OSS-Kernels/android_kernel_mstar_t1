...
#define BOARD_NAME                              "BD_MST244B_D01B_S_MASERATI"
...
//Panel
#define BALL_B18_IS_GPIO                        GPIO_OUT_HIGH            //Panel_ON-P1-C (Panel)     (Low: On / High: Off)
#define BALL_B17_IS_GPIO                        GPIO_OUT_HIGH            //VBLCTRL-P2-C  (Backlight) (Low: On / High: Off)

//audio
#define BALL_C15_IS_GPIO                        GPIO_OUT_HIGH            //AMP_EN (Low: On / High: Mute)
#define BALL_AH4_IS_GPIO                        GPIO_OUT_HIGH            //AUMUTE_OUT (Low: On / High: Mute)
#define BALL_C17_IS_GPIO                        GPIO_OUT_LOW             //MUTE-POP-RCA-C (Low: Mute / High: On)
#define BALL_B10_IS_GPIO                        GPIO_OUT_HIGH            //MUTE-POP-HP (Low: On / High: Mute)
#define BALL_B15_IS_GPIO                        GPIO_IN                  //HP_DET

//SD
#define BALL_AH6_IS_GPIO                        GPIO_OUT_HIGH           //SD-WP
#define BALL_R6_IS_GPIO                         GPIO_IN                 //SD-CDZ

//MHL
#define BALL_A10_IS_GPIO                        GPIO_IN                 //MHL_CABLE_DET
#define BALL_AM2_IS_GPIO                        GPIO_OUT_HIGH           //MHL_VBUS_EN (Low: On / High: Off)

//USB
#define BALL_N5_IS_GPIO                         GPIO_OUT_HIGH           //USB3_CTL_P0-C (Low: Off / High: On)
#define BALL_P6_IS_GPIO                         GPIO_OUT_HIGH           //USB3_CTL_P1-C (Low: Off / High: On)
#define BALL_AL5_IS_GPIO                        GPIO_IN                 //USB3_OCD_P0-C
...
// Audio Amplifier
#define Audio_Amplifier_ON()                    mdrv_gpio_set_low(BALL_C15)
#define Audio_Amplifier_OFF()                   mdrv_gpio_set_high(BALL_C15)

#define Adj_Volume_On()                         mdrv_gpio_set_low(BALL_AH4)
#define Adj_Volume_Off()                        mdrv_gpio_set_high(BALL_AH4)

//------ PANEL RELATED ---------------------------------------------------------
#define Panel_VCC_ON()                          mdrv_gpio_set_low(BALL_B18)
#define Panel_VCC_OFF()                         mdrv_gpio_set_high(BALL_B18)
#define Panel_Backlight_VCC_ON()                mdrv_gpio_set_low(BALL_B17)
#define Panel_Backlight_VCC_OFF()               mdrv_gpio_set_high(BALL_B17)
