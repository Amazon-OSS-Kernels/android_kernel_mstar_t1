...
#define BOARD_NAME                              "BD_MST244C_D01A_S_MASERATI"
...
//=============================================================================
#define BALL_AH7_IS_GPIO                        GPIO_OUT_HIGH            //POWER_SW (Low: Off / High: On)
#define BALL_K5_IS_GPIO                         GPIO_OUT_LOW             //PCM_PWR_CTL (Low: Off / High: On)

//Panel
#define BALL_G6_IS_GPIO                         GPIO_OUT_HIGH            //Panel_ON-P1-C (Panel)     (Low: On / High: Off)
#define BALL_AJ6_IS_GPIO                        GPIO_OUT_HIGH            //VBLCTRL-P2-C  (Backlight) (Low: On / High: Off)

//audio
#define BALL_AJ7_IS_GPIO                        GPIO_OUT_LOW            //AMP_EN (Low: On / High: Mute)
#define BALL_W4_IS_GPIO                         GPIO_OUT_LOW            //AUMUTE_OUT (Low: On / High: Mute)
#define BALL_W5_IS_GPIO                         GPIO_OUT_LOW             //MUTE-POP-RCA-C (Low: Mute / High: On)
//#define BALL_B10_IS_GPIO                        GPIO_OUT_HIGH            //MUTE-POP-HP (Low: On / High: Mute)
//#define BALL_B15_IS_GPIO                        GPIO_IN                  //HP_DET

//SD
#define BALL_T5_IS_GPIO                         GPIO_OUT_HIGH           //SD-WP
#define BALL_AH9_IS_GPIO                        GPIO_IN                 //SD-CDZ

//MHL
#define BALL_F7_IS_GPIO                         GPIO_IN                 //MHL_CABLE_DET
#define BALL_AJ2_IS_GPIO                        GPIO_OUT_HIGH           //MHL_VBUS_EN (Low: On / High: Off)

//USB
#define BALL_AC5_IS_GPIO                        GPIO_OUT_HIGH           //USB3_CTL_P0-C (Low: Off / High: On)
//#define BALL_P6_IS_GPIO                         GPIO_OUT_HIGH           //USB3_CTL_P1-C (Low: Off / High: On)
#define BALL_AH10_IS_GPIO                       GPIO_IN                 //USB3_OCD_P0-C
//#define BALL_Y4_IS_GPIO                         GPIO_IN                 //USB3_OCD_P1-C

//SWI2C
#define BALL_K6_IS_GPIO                         GPIO_IN                 //I2C-SCL (EEPROM)
#define BALL_J6_IS_GPIO                         GPIO_IN                 //I2CM-SDA (EEPROM)
...
#define PAD_VID2_IS_GPIO                        GPIO_OUT_HIGH           //VID2
#define PAD_VID3_IS_GPIO                        GPIO_OUT_HIGH           //VID3
#define PAD_VID4_IS_GPIO                        GPIO_OUT_HIGH           //VID4
#define PAD_VID5_IS_GPIO                        GPIO_OUT_HIGH           //VID5
...
#define AUDIO_SOURCE_SCART                      AUDIO_AUI2_INPUT
...
// Audio Amplifier
#define Audio_Amplifier_ON()                    mdrv_gpio_set_high(BALL_AJ7)
#define Audio_Amplifier_OFF()                   mdrv_gpio_set_low(BALL_AJ7)

#define Adj_Volume_On()                         mdrv_gpio_set_high(BALL_W4)
#define Adj_Volume_Off()                        mdrv_gpio_set_low(BALL_W4)

//------ PANEL RELATED ---------------------------------------------------------
#define Panel_VCC_ON()                          mdrv_gpio_set_low(BALL_G6)
#define Panel_VCC_OFF()                         mdrv_gpio_set_high(BALL_G6)
#define Panel_Backlight_VCC_ON()                mdrv_gpio_set_low(BALL_AJ6)
#define Panel_Backlight_VCC_OFF()               mdrv_gpio_set_high(BALL_AJ6)
...
#define PCMCIA_VCC_ON()                         mdrv_gpio_set_high(BALL_K5)
#define PCMCIA_VCC_OFF()                        mdrv_gpio_set_low(BALL_K5)
