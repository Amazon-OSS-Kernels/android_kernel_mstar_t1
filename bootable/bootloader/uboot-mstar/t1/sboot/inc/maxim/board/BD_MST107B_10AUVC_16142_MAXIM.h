...
#define BOARD_NAME                              "BD_MST107B_10AUVC_16142_MAXIM"
...
#define PAD_GPIO0_PM_IS_GPIO                    GPIO_OUT_LOW           //VBL_CTRL: Backlight                        (Low: Off / High: On)

//PWR
#define PAD_GPIO4_PM_IS_GPIO                    GPIO_OUT_HIGH           //PWR-ON/OFF: Switch out all system power    (Low: Off / High: On)

//audio
#define PAD_GPIO8_PM_IS_GPIO                    GPIO_OUT_HIGH           //AMP-MUTE: Mute sound                       (Low: On / High: Mute)
#define PAD_TGPIO0_IS_GPIO                      GPIO_OUT_HIGH           //AMP-Reset: AMP-RESET                       (Low: Reset / High : Normal)

//LED
#define PAD_GPIO11_PM_IS_GPIO                   GPIO_OUT_HIGH           //LED-R: Control LED on off                  (Low: Off / High: On)
...
//WIFI
#define PAD_GPIO2_IS_GPIO                       GPIO_OUT_HIGH           //WIFI-Reset: WIFI-Reset                     (Low: Reset / High: Normal)

//SD : config by driver itself

//USB
#define PAD_WOL_INT_OUT_IS_GPIO                 GPIO_OUT_LOW           //USB3_EN: USB3.0  power switch              (Low: Off / High: On)

//SWI2C
#define PAD_DDCR_DA_IS_GPIO                     GPIO_IN                 //DDCR_DA
#define PAD_DDCR_CK_IS_GPIO                     GPIO_IN                 //DDCR_CK

#define PAD_TGPIO2_IS_GPIO                      GPIO_IN                 //I2C-SCL (EEPROM)
#define PAD_TGPIO3_IS_GPIO                      GPIO_IN                 //I2CM-SDA (EEPROM)

//Demod
//#define PAD_TGPIO1_IS_GPIO                      GPIO_OUT_LOW            //Demod_RST

#define PAD_PWM2_IS_GPIO                        GPIO_OUT_HIGH           //PCMCIA Power Control
...
#define REG_USB30_GPIO_BANK                     0x2E
...
#define	FCIE_CD_OFFSET		0x0E		// 8 bits address offset
...
#define	FCIE_WP_OPT			2			// 0: not support, 1: low write protect, 2: high write protect
#define	FCIE_WP_BANK		0x102B		// IN register bank
#define	FCIE_WP_OFFSET		0x04		// 8 bits address offset
#define FCIE_WP_BIT			BIT2		// IN value bit
...
// card detection GPIO input setting
#define	SDIO_CD_OPT			0			// 0: always remove, 1: insert low, 2: insert high, 3: always insert
#define	SDIO_CD_BANK		0x0000		// IN register bank
#define	SDIO_CD_OFFSET		0x00		// 8 bits address offset
#define SDIO_CD_BIT			BIT0		// IN value bit
...
#define EMMC_TYPE                               EMMC_TYPE_HS200
#else
...
// Audio Amplifier
#define Audio_Amplifier_ON()                    mdrv_gpio_set_high(PAD_GPIO8_PM)
#define Audio_Amplifier_OFF()                   mdrv_gpio_set_low(PAD_GPIO8_PM)

#define Adj_Volume_On()                         mdrv_gpio_set_high(PAD_TGPIO0)
#define Adj_Volume_Off()                        mdrv_gpio_set_low(PAD_TGPIO0)
