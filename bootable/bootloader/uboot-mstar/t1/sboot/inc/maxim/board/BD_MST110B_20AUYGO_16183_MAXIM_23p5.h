...
#define BOARD_NAME                              "BD_MST110B_20AUYGO_16183_MAXIM"
...
#define PADS_NAND_MODE                          CONFIG_PADMUX_MODE2     //Option: CONFIG_PADMUX_MODE1 / DISABLE
...
#define PADS_MCU_JTAG_MODE                      DISABLE                 //Option: CONFIG_PADMUX_MODE1 / CONFIG_PADMUX_MODE2 / DISABLE
#define PADS_EJTAG_MODE                         DISABLE                 //Option: CONFIG_PADMUX_MODE1 / CONFIG_PADMUX_MODE2 / DISABLE
...
#define PADS_VSYNC_LIKE_CFG                     CONFIG_PADMUX_MODE3     //Option: CONFIG_PADMUX_MODE1 / CONFIG_PADMUX_MODE2 / CONFIG_PADMUX_MODE3 / DISABLE

#define PADS_LD_SPI1_CFG                        DISABLE                 //Option: ENABLE / DISABLE
#define PADS_LD_SPI2_CFG                        DISABLE                 //Option: ENABLE / DISABLE
#define PADS_LD_SPI3_CFG                        DISABLE                 //Option: ENABLE / DISABLE
...
#define PADS_MIIC_MODE1                         DISABLE                 //Option: CONFIG_PADMUX_MODE1 / CONFIG_PADMUX_MODE2 / DISABLE
...
#define PADS_SD_CFG                             DISABLE                 //Option: CONFIG_PADMUX_MODE1 / CONFIG_PADMUX_MODE2 / CONFIG_PADMUX_MODE1 / DISABLE
#define PADS_SDIO_CFG                           DISABLE                 //Option: CONFIG_SDIO_MODE0 / CONFIG_SDIO_MODE1 / DISABLE

#define PADS_3D_FLAG_CFG                        CONFIG_PADMUX_MODE1     //Option: CONFIG_PADMUX_MODE1 / CONFIG_PADMUX_MODE2 / CONFIG_PADMUX_MODE3 / DISABLE
#define PADS_OSD_3D_FLAG_CFG                    DISABLE                 //Option: CONFIG_PADMUX_MODE1 / CONFIG_PADMUX_MODE2 / CONFIG_PADMUX_MODE3 / DISABLE

#define PADS_PCM_CTRL_CFG                       DISABLE
#define PADS_SM_CFG                             DISABLE                 //Option: CONFIG_PADMUX_MODE1 / CONFIG_PADMUX_MODE2 / DISABLE
//=============================================================================
//Panel
#define PAD_SAR2_IS_GPIO                        GPIO_OUT_LOW           //PANEL_ON/OFF: Panel power switch           (Low: Off / High: On)
#define PAD_GPIO0_PM_IS_GPIO                    GPIO_OUT_HIGH           //VBL_CTRL: Backlight                        (Low: Off / High: On)

//PWR
#define PAD_GPIO4_PM_IS_GPIO                    GPIO_OUT_HIGH           //PWR-ON/OFF: Switch out all system power    (Low: Off / High: On)

//audio
#define PAD_GPIO8_PM_IS_GPIO                    GPIO_OUT_HIGH            //AMP-MUTE (Low: On / High: Mute)
#define PAD_GPIO30_IS_GPIO                      GPIO_OUT_HIGH            //AMP-Reset (Low: Reset / High : Normal)
#define PAD_PCM_D3_IS_GPIO                      GPIO_OUT_LOW             //AMP disable
//VID
#define PAD_VID0_IS_GPIO                        GPIO_OUT_HIGH           //VID0: CORE POWER CONTROL
#define PAD_VID1_IS_GPIO                        GPIO_OUT_HIGH           //VID1: CORE POWER CONTROL

//USB
#define PAD_GPIO9_IS_GPIO                       GPIO_OUT_HIGH            //USB3_EN (Low: Off / High: On)

//WIFI ENABLE
#define PAD_GPIO3_PM_IS_GPIO                    GPIO_OUT_HIGH            //WIFI_EN (Low: Off / High: On)

//WIFI Reset
#define PAD_SAR3_IS_GPIO                        GPIO_OUT_HIGH            //WIFI_reset (Low reset)

//WOWL
#define PAD_WOL_INT_OUT_IS_GPIO                 GPIO_IN                  //WOWL wake up pin.
...
//POH1_ON
#define PAD_PM_SPI_DI_IS_GPIO                   GPIO_OUT_LOW

//LNB_EN
#define PAD_TGPIO0_IS_GPIO                      GPIO_OUT_HIGH

//SSW, high: engineer mode, low: mp mode
#define PAD_PCM_IORD_N_IS_GPIO                  GPIO_IN

//Debug on, high: debug mode speaker not mute, low: headphone mode speaker mute
#define PAD_PCM_D5_IS_GPIO                      GPIO_IN
...
#define CONFIG_SIDD_THRESHOLD_CPU               44
#define CONFIG_OSC_THRESHOLD_CPU                177
#define CONFIG_SIDD_THRESHOLD                   230
#define CONFIG_OSC_THRESHOLD_GPU                205
#endif

//==================================USB 3.0======================================
#define REG_USB30_GPIO_CONTROL                  0x1225FC
#define REG_USB30_GPIO_BANK                     0x0F
#define REG_USB30_GPIO_OFFSET                   0x06 //bit0~bit7 offset addr
...
#define FCIE_CD_BIT			BIT0		// IN value bit
...
#define FCIE_PC_BIT			BIT0		// OUT value bit
...
#define	SDIO_WP_BANK		0x000F		// IN register bank
#define	SDIO_WP_OFFSET		0x02		// 8 bits address offset
#define SDIO_WP_BIT			BIT2		// IN value bit
...
#define MIU1_SSC_ENABLE DISABLE
...
#define VBY1_SSC_MODULATION                     400
#define VBY1_SSC_DEVIATION                       50
...
// WIFI Reset
#define Wifi_Reset_ON()                         mdrv_gpio_set_low(PAD_SAR3)
#define Wifi_Reset_OFF()                        mdrv_gpio_set_high(PAD_SAR3)

// Audio Amplifier
#define Audio_Amplifier_ON()                    mdrv_gpio_set_high(PAD_GPIO30)
#define Audio_Amplifier_OFF()                   mdrv_gpio_set_low(PAD_GPIO30)

#define Adj_Volume_On()                         mdrv_gpio_set_high(PAD_GPIO8_PM)
#define Adj_Volume_Off()                        mdrv_gpio_set_low(PAD_GPIO8_PM)
...
// LED Control
#define CONFIG_LED_RED_IS_PWM 1
#if (CONFIG_LED_RED_IS_PWM == 1)
#define REG_PWM_PM_IS_GPIO     0x0E38
#define REG_PWM_AS_CHIP_CONFIG 0x0EE0
#define REG_PM_PWM_PERIOD      0x0ED4
#define REG_PM_PWM_DUTY        0x0ED2
#define LED_RED_PWM_PERIOD_MAX 0x200
#define LED_RED_PWM_INIT() {                                    \
    /* reg_pwm_pm_is_gpio = FALSE */                            \
    WriteRegBit(REG_PWM_PM_IS_GPIO, BIT5, FALSE);               \
    /* reg_pwm_as_chip_config = FALSE */                        \
    WriteRegBit(REG_PWM_AS_CHIP_CONFIG, BIT0, FALSE);           \
    /* MDrv_PM_PWM_Period */                                    \
    Write2Byte(REG_PM_PWM_PERIOD, LED_RED_PWM_PERIOD_MAX); \
}

// Adjust MDrv_PM_PWM_DutyCycle to _PERCENTAGE%
#define LED_RED_ON_PWM(_PERCENTAGE) Write2Byte(REG_PM_PWM_DUTY, (LED_RED_PWM_PERIOD_MAX * (_PERCENTAGE)) / 100)

// Adjust MDrv_PM_PWM_DutyCycle to 100%, which is LED_RED_PWM_PERIOD_MAX
#define LED_RED_ON() Write2Byte(REG_PM_PWM_DUTY, LED_RED_PWM_PERIOD_MAX)

// Adjust MDrv_PM_PWM_DutyCycle to 0%
#define LED_RED_OFF() Write2Byte(REG_PM_PWM_DUTY, 0x0)
...
//--------HDMI TX---------
#define PAD_HDMI_TX_HOTPLUG                    DISABLE
