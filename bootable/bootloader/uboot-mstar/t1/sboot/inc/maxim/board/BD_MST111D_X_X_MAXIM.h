...
#define BOARD_NAME                              "BD_MST111D_X_X_MAXIM"
...
#define PADS_UART2_MODE                         CONFIG_PADMUX_MODE3     //Option: CONFIG_PADMUX_MODE1 / CONFIG_PADMUX_MODE2 / CONFIG_PADMUX_MODE3 / DISABLE
...
#if defined(CONFIG_TV_HDMITX_MSTAR)
#include "chip/MSD95UVEH4.h"
#else
