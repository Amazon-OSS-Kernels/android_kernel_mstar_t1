...
#define BOARD_NAME                              "BD_MST253A_D01A_S_MAXIM"
...
//SPI_FLASH1 write protect
#define PAD_GPIO1_PM_IS_GPIO                    GPIO_OUT_HIGH          //Output SPI_FLASH1 write protect Low :protect

//SPI_FLASH2 write protect
#define PAD_GPIO3_PM_IS_GPIO                    GPIO_OUT_HIGH          //Output SPI_FLASH2 write protect Low :protect

//HDMI hot plug/MOD
#define PAD_GPIO2_PM_IS_GPIO                    GPIO_OUT_LOW           //Output HDMI TX Hotplug, but MOD package need to set low
#define PAD_GPIO36_PM_IS_GPIO                   GPIO_OUT_LOW
#define PAD_GPIO37_PM_IS_GPIO                   GPIO_OUT_LOW

//HDMI hot plug/MOD
#define PAD_GPIO5_PM_IS_GPIO                    GPIO_OUT_LOW           //Audio Class D mute out
...
//USB
#define PAD_GPIO12_IS_GPIO                      GPIO_OUT_LOW           //USB3_EN: USB3.0  power switch              (Low: Off / High: On)
...
#define PAD_PWM1_IS_GPIO                        GPIO_OUT_HIGH           //PCMCIA Power Control
#define PAD_PWM2_IS_GPIO                        GPIO_OUT_LOW
...
#define REG_USB30_GPIO_OFFSET                   0x0C //bit0~bit7 offset addr
...
// Audio Amplifier
#define Audio_Amplifier_ON()                    mdrv_gpio_set_high(PAD_TGPIO0)
#define Audio_Amplifier_OFF()                   mdrv_gpio_set_low(PAD_TGPIO0)

#define Adj_Volume_On()                         mdrv_gpio_set_low(PAD_GPIO8_PM)
#define Adj_Volume_Off()                        mdrv_gpio_set_high(PAD_GPIO8_PM)
