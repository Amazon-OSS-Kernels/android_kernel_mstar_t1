...
#define BOARD_NAME                              "BD_MST253C_D01A_S_MAXIM"
...
#define PADS_PWM0_MODE                          DISABLE                  //Option: ENABLE / DISABLE
...
//=============================================================================
//#define PAD_GPIO4_PM_IS_GPIO                  GPIO_OUT_HIGH            //PWR-ON/OFF (Low: Off / High: On)

//Panel
#define PAD_SAR2_IS_GPIO                        GPIO_OUT_HIGH            //PANEL_ON/OFF (Panel)     (Low: Off / High: On)
...
#define PAD_TGPIO0_IS_GPIO                      GPIO_OUT_LOW             //AMP-Reset (Low: Reset / High : Normal)
...
//USB
#define PAD_WOL_INT_OUT_IS_GPIO                 GPIO_OUT_LOW            //USB3_EN (Low: Off / High: On)
...
//WIFI-Reset
#define PAD_GPIO2_IS_GPIO                       GPIO_OUT_LOW

//Demod
#define PAD_TGPIO1_IS_GPIO                      GPIO_OUT_HIGH
