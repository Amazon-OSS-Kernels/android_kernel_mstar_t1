...
#define _MIU_MST111D_X_X_MAXIM_STR_H_
...
const MS_REG_INIT MIU0_DDR_Init_Str[] =
{
    ...
    _RV32_2(0x110d00, 0x000a), //reg_pkg_sel = 2
#endif
#else
...
const MS_REG_INIT MIU1_DDR_Init_Str[] =
{
    ...
    _RV32_2(0x161694, 0x0607),  // k/2 offset
    _RV32_2(0x161696, 0x0406),  // k/2 offset
#endif
    ...
    _RV32_2(0x161600, 0x0008),
    _RV32_2(0x100600, 0x0000),
    _RV32_2(0x161600, 0x000b), //reg_pkg_sel = 3
...
#endif /* _MIU_MST111D_X_X_MAXIM_STR_H_ */
