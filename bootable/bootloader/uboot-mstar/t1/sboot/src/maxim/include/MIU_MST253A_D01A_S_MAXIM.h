...
#define _MIU_MST253A_D01A_S_MAXIM_H_

#if (ENABLE_MSTAR_BD_MST253A_D01A_S_MAXIM == 1)
...
const MS_REG_INIT MIU0_DDR_Init[] =
{
    ...
    _RV32_2(0x110d0a, 0x11c9),
    _RV32_2(0x110d0e, 0x0099),
    _RV32_2(0x110d2e, 0x4333),
    _RV32_2(0x110d38, 0x4477),
    _RV32_2(0x110d3a, 0x3067),
    _RV32_2(0x110d3c, 0x1233),
    _RV32_2(0x110d3e, 0xa022),
    _RV32_2(0x110d48, 0x6677),
    _RV32_2(0x110d4a, 0x66a6),
    ...
    //driving setting
    _RV32_2(0x110d58, 0x0707), //driving: @20160427 hsin-yen suggest default value
    ...
    //trig. lvl setting
    _RV32_2(0x110d74, 0x0a0a), //trig. lvl: @20160415 hsin-yen suggest default value
    _RV32_2(0x110d76, 0x0a0a), //trig. lvl: @20160415 hsin-yen suggest default value
...
const MS_REG_INIT MIU1_DDR_Init[] =
{
    ...
    _RV32_2(0x101630, 0xf45a),
    _RV32_2(0x101632, 0x001d),
    _RV32_2(0x101636, 0x0400),
    ...
    //trig. lvl setting
    _RV32_2(0x161674, 0x0606), //trig. lvl: @20160415 hsin-yen suggest default value
    _RV32_2(0x161676, 0x0606), //trig. lvl: @20160415 hsin-yen suggest default value
...
#endif  //ENABLE_MSTAR_BD_MST253A_D01A_S_MAXIM
#endif /* _MIU_MST253A_D01A_S_MAXIM_H_ */
