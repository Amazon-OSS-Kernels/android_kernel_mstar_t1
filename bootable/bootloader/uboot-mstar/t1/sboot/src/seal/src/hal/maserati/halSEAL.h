...
#define _phy_to_miu_offset(MiuSel, Offset, PhysAddr) if (PhysAddr < HAL_MIU1_BASE) \
                                                        {MiuSel = 0; Offset = PhysAddr;} \
                                                         ...
                                                         {MiuSel = 2; Offset = PhysAddr - HAL_MIU2_BASE;}
...
#define REG_TZPC_NONPM_MIU_HOST            (SEAL_TZPC_NONPM_BASE+0x80)
#define REG_TZPC_NONPM_SECURE_REG            (SEAL_TZPC_NONPM_BASE+0xC8)

#define SEAL_TZPC_NONPM_MIU                     (0x00122F00UL)
...
#define SEAL_SECURE2_RANGE0                     (0x00121900UL)

#define REG_SECURE_RANGE0_START_ADDR           (0x00UL)
#define REG_SECURE_RANGE0_END_ADDR             (0x08UL)
#define REG_SECURE_RANGE0_ATTRIBUTE            (0x0EUL)

#define REG_SECURE_RANGE_OFFSET                 (0x10)

#define REG_SECURE0_DETECT_ENABLE               (0xECUL)

#define REG_SECURE_RANGE_NUM                    (0x8)
...
int HAL_SEAL_SetSecureRange(unsigned int rangeId, unsigned long long startAddr, unsigned long long endAddr, int attr);
