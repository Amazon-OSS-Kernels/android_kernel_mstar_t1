...
#if ((FRONTEND_DEMOD_TYPE == MSTAR_MSB123x_DEMOD) || (FRONTEND_DEMOD_TYPE == MSTAR_MSB1233c_DEMOD)||(FRONTEND_DEMOD_TYPE == EMBEDDED_DVBC_DEMOD)||(FRONTEND_DEMOD_TYPE == EMBEDDED_DVBS_DEMOD)||(FRONTEND_DEMOD_TYPE == MSTAR_MSB1238_DEMOD)||(FRONTEND_DEMOD_TYPE == MSTAR_MSB124x_DEMOD)||(FRONTEND_DEMOD_TYPE == MSTAR_MSB1245_DEMOD)  \
