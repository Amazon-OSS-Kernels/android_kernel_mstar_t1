...
#if defined(CONFIG_MSTAR_KAISER) || defined(CONFIG_MSTAR_KERES)|| defined(CONFIG_MSTAR_KIRIN) || defined(CONFIG_MSTAR_KRIS) || defined(CONFIG_MSTAR_KAYLA)  || defined(CONFIG_MSTAR_KANO) || defined(CONFIG_MSTAR_CURRY)
...
#if defined(CONFIG_MSTAR_KAISER) || defined(CONFIG_MSTAR_KERES)|| defined(CONFIG_MSTAR_KIRIN) || defined(CONFIG_MSTAR_KRIS) || defined(CONFIG_MSTAR_KAYLA)
