...
#elif (FRONTEND_DEMOD_TYPE == EMBEDDED_DVBC_DEMOD)
    Power_On_Initialization();
#elif ((FRONTEND_DEMOD_TYPE == MSTAR_MSB1238_DEMOD)||(FRONTEND_DEMOD_TYPE == MSTAR_MSB124x_DEMOD)||(FRONTEND_DEMOD_TYPE == MSTAR_MSB1245_DEMOD) || (FRONTEND_DEMOD_TYPE == EMBEDDED_DVBS_DEMOD))
    MDrv_Demod_Init();
#endif

// init tuner
#if ((FRONTEND_DEMOD_TYPE != MSTAR_MSB1238_DEMOD)&&(FRONTEND_DEMOD_TYPE != MSTAR_MSB124x_DEMOD)&&(FRONTEND_DEMOD_TYPE != EMBEDDED_DVBC_DEMOD)&&(FRONTEND_DEMOD_TYPE != EMBEDDED_DVBS_DEMOD)&&(FRONTEND_DEMOD_TYPE != MSTAR_MSB1245_DEMOD)&&(FRONTEND_DEMOD_TYPE != MSTAR_MSB123x_DEMOD)&&(FRONTEND_DEMOD_TYPE != MSTAR_MSB123xc_DEMOD)&&(FRONTEND_DEMOD_TYPE != MSTAR_MSB1400_DEMOD))//MDrv_Demod_Init has included tuner init
...
#if ((FRONTEND_DEMOD_TYPE != MSTAR_MSB1238_DEMOD)&&(FRONTEND_DEMOD_TYPE != MSTAR_MSB124x_DEMOD)&&(FRONTEND_DEMOD_TYPE != EMBEDDED_DVBC_DEMOD)&&(FRONTEND_DEMOD_TYPE != EMBEDDED_DVBS_DEMOD)&&(FRONTEND_DEMOD_TYPE != MSTAR_MSB1245_DEMOD)&&(FRONTEND_DEMOD_TYPE != MSTAR_MSB123x_DEMOD)&&(FRONTEND_DEMOD_TYPE != MSTAR_MSB123xc_DEMOD)&&(FRONTEND_DEMOD_TYPE != MSTAR_MSB1400_DEMOD))
...
BOOLEAN devCOFDM_SetDemodType(EN_DEVICE_DEMOD_TYPE enDemodType)
{
    return MSB124X_SetCurrentDemodulatorType(enDemodType);
}
EN_DEVICE_DEMOD_TYPE devCOFDM_GetDemodType(void)
{
