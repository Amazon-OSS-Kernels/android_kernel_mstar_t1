...
PanelType  tDACOUT480I_60[] =
{
    {//Dac Out for U3 bringup
        ...
        #if(ENABLE_MSTAR_MONACO==1 ||ENABLE_MSTAR_MUJI==1 || ENABLE_MSTAR_MONET==1 || ENABLE_MSTAR_MANHATTAN==1 ||ENABLE_MSTAR_KANO==1 ||ENABLE_MSTAR_MESSI==1 || ENABLE_MSTAR_MASERATI==1|| ENABLE_MSTAR_MACAN==1 || ENABLE_MSTAR_CURRY==1 ||ENABLE_MSTAR_MAXIM==1)
