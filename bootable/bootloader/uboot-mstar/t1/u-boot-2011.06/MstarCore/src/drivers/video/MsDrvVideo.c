...
//    //====================================
    ...
    printf("RATE:%ld STC:%lx PTS(V:%lx A:%lx)(Seq:%ld I:%ld 1stF:%ld)AV(on:%ld S:%ld R:%ld)(Dec:%lu Err:%lu Skp:%lu Drp:%lu Disp:%lu)ES(R:%6lx W:%6lx V:%6lx)DELTA(V:%4d A:%4d) ADEC(Dec:%lu)\n",
            u32Rate, u32SystemSTC, u32VPTS, u32APTS,
            (MS_U32)MApi_VDEC_EX_IsSeqChg(&stGetStreamId), (MS_U32)MApi_VDEC_EX_IsIFrameFound(&stGetStreamId), (MS_U32)MApi_VDEC_EX_IsFrameRdy(&stGetStreamId),
