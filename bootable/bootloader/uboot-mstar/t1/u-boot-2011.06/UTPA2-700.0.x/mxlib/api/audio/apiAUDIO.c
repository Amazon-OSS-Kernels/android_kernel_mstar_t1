...
void _MApi_Audio_Monitor(void)
{
    ...
    MS_U8  u8CurrentSeWhile, u8CurrentSeISR, u8CurrentDecR2While, u8CurrentDecR2Timer, u8CurrentSndR2While, u8CurrentSndR2Timer;
    ...
    else if ((u8SndR2WhileFailCount>=10)||(u8SndR2TimerFailCount>=10))//Checking if rebooting SE R2
    {
...
AUDIO_DEC_ID _MApi_AUDIO_OpenDecodeSystem(AudioDecStatus_t * p_AudioDecStatus)
{
    ...
    APIAUDIO_CHECK_INIT_FLAG(DecRet);
    if (DecRet == FALSE)
    {
        return DecRet;
    }
...
void _MApi_AUDIO_SPDIF_SetMute(MS_BOOL mute_en)
{
    ...
    g_AudioVars2->g_SPDIF_MuteStatus = mute_en;
