    ...
    switch(u32Cmd)
    {
        ...
        case MApi_CMD_DMX_Sec_ReadAddr:
            ...
            if(pu32Param[3] == 1UL)
            {
                ptrTmp = (void*)(pu32Param + 1);
                phyaddr = *((MS_PHY*)ptrTmp);
                pu32Param[4] = (MS_U32)psDmxInstPri->fpDMXSecSetReadAddr((MS_U8)(pu32Param[0]), phyaddr);
            }
            else
            {
                pu32Param[4] = (MS_U32)psDmxInstPri->fpDMXSecGetReadAddr((MS_U8)(pu32Param[0]), &phyaddr);
        ...
        case MApi_CMD_DMX_Sec_GetWriteAddr:
            ...
            pu32Param = (MS_U32*)pArgs;
            pu32Param[3] = (MS_U32)psDmxInstPri->fpDMXSecGetWriteAddr((MS_U8)(pu32Param[0]), &phyaddr);
            _DMX_PhyAddr_To_U32Param(phyaddr, pu32Param+1UL);
            break;
        ...
        case MApi_CMD_DMX_Sec_GetStartAddr:
            ...
            pu32Param = (MS_U32*)pArgs;
            pu32Param[3] = (MS_U32)psDmxInstPri->fpDMXSecGetStartAddr((MS_U8)(pu32Param[0]), &phyaddr);
            _DMX_PhyAddr_To_U32Param(phyaddr, pu32Param+1UL);
            break;
        ...
        case MApi_CMD_DMX_Sec_GetEndAddr:
            ...
            pu32Param = (MS_U32*)pArgs;
            pu32Param[3] = (MS_U32)psDmxInstPri->fpDMXSecGetEndAddr((MS_U8)(pu32Param[0]), &phyaddr);
        ...
        case MApi_CMD_DMX_GetTTXWrite:
            ...
            pu32Param = (MS_U32*)pArgs;
            pu32Param[3] = (MS_U32)psDmxInstPri->fpDMXGetTTXWrite((MS_U8)(pu32Param[0]), &phyaddr);
            _DMX_PhyAddr_To_U32Param(phyaddr, pu32Param+1UL);
            break;
        ...
        case MApi_CMD_DMX_FQ_Configure:
            DMX_MSG(printf("DMXIoctl - MApi_CMD_DMX_FQ_Configure\n"));
