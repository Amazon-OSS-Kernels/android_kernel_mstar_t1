                             ...
                             GFX_TextOutInfo *pfmt)
{
    ...
    void          (*fpGFX_CBGetFont)(MS_S8, GFX_FontInfo*)=NULL;
...
#if 1
{
    ...
    {
        MS_U32 ret;
        ret = (MS_U32)GFX_TextOutEx(pInstance,fhandle, pindex, strwidth, pfmt);
        MApi_GFX_SetSrcColorKey_U02(pInstance, FALSE, CK_OP_EQUAL, GFX_FMT_ARGB8888, &tmpclr1, &tmpclr2);
...
static MS_S32 Ioctl_GFX_SetConfig(void* pInstance, void* pArgs)
{
    ...
    GFX_Set_PaletteOpt_ARRY*     pGFXSetPaletteOpt   =NULL;
    ...
    switch(eCmd)
    {
        ...
        case E_GFX_SET_PALETTEOPT:
            CheckSize(pGFXSetConfig->u32Size, sizeof(GFX_Set_PaletteOpt_ARRY), eCmd);
            pGFXSetPaletteOpt = (GFX_Set_PaletteOpt_ARRY*)pGFXSetConfig->pGFX_ConfigInfo;
            MApi_GFX_SetPaletteOpt_U02(pInstance, pGFXSetPaletteOpt->PalArray, pGFXSetPaletteOpt->u32PalStart, pGFXSetPaletteOpt->u32PalEnd);
            u32Ret = GFX_SUCCESS;
            break;
...
MS_U32 GFXIoctl(void* pInstance, MS_U32 u32Cmd, void* pArgs)
{
    if(pInstance == NULL)
    {
        GFX_CRITIAL_MSG(GFX_DBUG("[%s:%s:%d]GFXIoctl's pInstance =NULL\n",__FILE__,__FUNCTION__,__LINE__));
