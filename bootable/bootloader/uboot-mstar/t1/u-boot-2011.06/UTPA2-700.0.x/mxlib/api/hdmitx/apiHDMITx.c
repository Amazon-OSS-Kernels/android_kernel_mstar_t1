...
void MApi_HDMITx_SetColorFormat(HDMITX_VIDEO_COLOR_FORMAT in_color, HDMITX_VIDEO_COLOR_FORMAT out_color)
{
    switch (in_color)
    {
        ...
        case HDMITX_VIDEO_COLOR_YUV420:
            gHDMITxInfo.input_color = E_HDMITX_VIDEO_COLOR_YUV420;
            break;
        default:
    ...
    switch (out_color)
    {
        ...
        case HDMITX_VIDEO_COLOR_YUV444:
            ...
            break;
        case HDMITX_VIDEO_COLOR_YUV420:
            gHDMITxInfo.output_color = E_HDMITX_VIDEO_COLOR_YUV420;
            break;
        default:
...
void MApi_HDMITx_SetVideoOutputTiming(HDMITX_VIDEO_TIMING mode)
{
    switch (mode)
    {
		...
		case HDMITX_RES_3840x2160p_24Hz:
		    gHDMITxInfo.output_video_timing = E_HDMITX_RES_3840x2160p_24Hz;
		    break;
		case HDMITX_RES_3840x2160p_25Hz:
            gHDMITxInfo.output_video_timing = E_HDMITX_RES_3840x2160p_25Hz;
            break;
        case HDMITX_RES_3840x2160p_30Hz:
            gHDMITxInfo.output_video_timing = E_HDMITX_RES_3840x2160p_30Hz;
            break;
        case HDMITX_RES_3840x2160p_50Hz:
            gHDMITxInfo.output_video_timing = E_HDMITX_RES_3840x2160p_50Hz;
            break;
        case HDMITX_RES_3840x2160p_60Hz:
            gHDMITxInfo.output_video_timing = E_HDMITX_RES_3840x2160p_60Hz;
            break;
        case HDMITX_RES_4096x2160p_24Hz:
            gHDMITxInfo.output_video_timing = E_HDMITX_RES_4096x2160p_24Hz;
            break;
        case HDMITX_RES_4096x2160p_25Hz:
            gHDMITxInfo.output_video_timing = E_HDMITX_RES_4096x2160p_25Hz;
            break;
        case HDMITX_RES_4096x2160p_30Hz:
            gHDMITxInfo.output_video_timing = E_HDMITX_RES_4096x2160p_30Hz;
            break;
        case HDMITX_RES_4096x2160p_50Hz:
            gHDMITxInfo.output_video_timing = E_HDMITX_RES_4096x2160p_50Hz;
            break;
        case HDMITX_RES_4096x2160p_60Hz:
            gHDMITxInfo.output_video_timing = E_HDMITX_RES_4096x2160p_60Hz;
            break;
        default:
    ...
    // For HDMI 1.4 spec, 4k2k@30 only support up to 24-bit color depth
...
{
	return MDrv_HDMITx_SetPowerState(u16PowerState);
}
// *************  For customer NDS **************//
#ifdef CUSTOMER_NDS
