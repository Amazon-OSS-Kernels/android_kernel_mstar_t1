        ...
        case MAPI_CMD_HDMIRX_HDCP22_HANDLER:
            {
                ...
                pHDMIRxArgs->bHdcp22RecvMsgFlag = psHDMIRxInstPri->fpHDMIRxHDCP22Handler(pInstance, pHDMIRxArgs->ucPortIdx, &pHDMIRxArgs->ucHdcp22PortType, pHDMIRxArgs->pucHdcp22MsgData, &pHDMIRxArgs->ucHdcp22MsgLen);
            }
            break;
