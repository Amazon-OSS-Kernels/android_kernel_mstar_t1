...
#define ACE_OSD_CONTROL_VERSION 0
...
WORD msACE_GetInfo(void* pInstance, BOOL bWindow, EnuACEInfoType ucInfoType )
{
    ...
    switch( ucInfoType )
    {
        ...
        case ACE_INFO_TYPE_IHC_COLOR_R:
        case ACE_INFO_TYPE_IHC_COLOR_G:
        case ACE_INFO_TYPE_IHC_COLOR_B:
        case ACE_INFO_TYPE_IHC_COLOR_C:
        case ACE_INFO_TYPE_IHC_COLOR_M:
        case ACE_INFO_TYPE_IHC_COLOR_Y:
        case ACE_INFO_TYPE_IHC_COLOR_F:
            {
                MS_U8 u8Val = 0;
                MDrv_ACE_GetIHC(pInstance, bWindow, ucInfoType, &u8Val);
                wReturnValue = u8Val;
            }
            break;


        case ACE_INFO_TYPE_ICC_COLOR_R:
        case ACE_INFO_TYPE_ICC_COLOR_G:
        case ACE_INFO_TYPE_ICC_COLOR_B:
        case ACE_INFO_TYPE_ICC_COLOR_C:
        case ACE_INFO_TYPE_ICC_COLOR_M:
        case ACE_INFO_TYPE_ICC_COLOR_Y:
        case ACE_INFO_TYPE_ICC_COLOR_F:
            {
                MS_U8 u8Val = 0;
                MDrv_ACE_GetICC(pInstance, bWindow, ucInfoType, &u8Val);
                wReturnValue = u8Val;
            }
            break;

        case ACE_INFO_TYPE_IBC_COLOR_R:
        case ACE_INFO_TYPE_IBC_COLOR_G:
        case ACE_INFO_TYPE_IBC_COLOR_B:
        case ACE_INFO_TYPE_IBC_COLOR_C:
        case ACE_INFO_TYPE_IBC_COLOR_M:
        case ACE_INFO_TYPE_IBC_COLOR_Y:
        case ACE_INFO_TYPE_IBC_COLOR_F:
            {
                MS_U8 u8Val = 0;
                MDrv_ACE_GetIBC(pInstance, bWindow, ucInfoType, &u8Val);
                wReturnValue = u8Val;
            }
            break;
...
void msACESetColorCorrectionTable(void* pInstance, BOOL bWindow, short* psColorCorrectionTable )
{
    ...
    if(psColorCorrectionTable!=NULL)
        memcpy(s_AceInfo[bWindow].psColorCorrectionMatrix,psColorCorrectionTable,32);
}
...
void msACE_HDR_ConfigMetadata_MpegVUI(void *pInstance,ACE_DRV_HDR_YUV2RGBData* pY2RData)
{
    ...
    switch (g_ACEinitParameters.ACE_HDRMetadataMpegVUI.u8MatrixCoefficients)
    {
     ...
     case 9: // 2020NCL
        ...
        break;
     case 10: // 2020CL
        pY2RData->u8SMode = 0;  // Spec is 2. Reference abc123 0959025.
        pY2RData->u16SKr = 13135; //0.2627
        pY2RData->u16SKb = 2965; //0.0593
        break;
     case 2: // Unspecified
