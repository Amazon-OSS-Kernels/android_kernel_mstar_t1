...
typedef enum
{
    ...
    ACE_INFO_TYPE_IHC_COLOR_R,
    ACE_INFO_TYPE_IHC_COLOR_G,
    ACE_INFO_TYPE_IHC_COLOR_B,
    ACE_INFO_TYPE_IHC_COLOR_C,
    ACE_INFO_TYPE_IHC_COLOR_M,
    ACE_INFO_TYPE_IHC_COLOR_Y,
    ACE_INFO_TYPE_IHC_COLOR_F,

    ACE_INFO_TYPE_ICC_COLOR_R,
    ACE_INFO_TYPE_ICC_COLOR_G,
    ACE_INFO_TYPE_ICC_COLOR_B,
    ACE_INFO_TYPE_ICC_COLOR_C,
    ACE_INFO_TYPE_ICC_COLOR_M,
    ACE_INFO_TYPE_ICC_COLOR_Y,
    ACE_INFO_TYPE_ICC_COLOR_F,

    ACE_INFO_TYPE_IBC_COLOR_R,
    ACE_INFO_TYPE_IBC_COLOR_G,
    ACE_INFO_TYPE_IBC_COLOR_B,
    ACE_INFO_TYPE_IBC_COLOR_C,
    ACE_INFO_TYPE_IBC_COLOR_M,
    ACE_INFO_TYPE_IBC_COLOR_Y,
    ACE_INFO_TYPE_IBC_COLOR_F,
