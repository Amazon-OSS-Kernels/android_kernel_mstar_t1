...
//#else
//typedef struct _DTMB_RESOURCE_PRIVATE
//#endif
{
...
MS_U32 DTMBStr(MS_U32 u32PowerState, void* pModule)
{
    ...
    u32Ret=_MDrv_DMD_DTMB_MD_SetPowerState(0,u32PowerState);
...
{
    DMD_DBG(printf("DTMBIoctl - enter\n"));
    void* pModule = NULL;
    ...
    //psDMD_DTMB_ResData = ((PDTMB_RESOURCE_PRIVATE)pResource)->sDMD_DTMB_ResData;
    psDMD_DTMB_ResData = ((PDTMB_RESOURCE_PRIVATE)psDTMBResPri)->sDMD_DTMB_ResData;
...
void DTMBRegisterToUtopia(FUtopiaOpen ModuleType)
{
    ...
    // initial resource
    //memset(psResource, 0, sizeof(DTMB_RESOURCE_PRIVATE)/2);
    // func to reg res
