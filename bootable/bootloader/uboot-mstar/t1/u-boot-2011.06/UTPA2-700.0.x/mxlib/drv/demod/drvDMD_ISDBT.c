...
{
    printf("LINK ERROR: Please link int demod library \n");
...
#endif
{
    ...
    else pRes->sDMD_ISDBT_PriData.HAL_DMD_ISDBT_IOCTL_CMD = HAL_INTERN_ISDBT_IOCTL_CMD;
    #else
    pRes->sDMD_ISDBT_PriData.HAL_DMD_ISDBT_IOCTL_CMD = HAL_EXTERN_ISDBT_IOCTL_CMD;
    #endif
...
MS_BOOL MDrv_DMD_ISDBT_MD_Exit(MS_U8 id)
{
    ...
    if (UtopiaIoctl(_ppISDBTInstant, DMD_ISDBT_DRV_CMD_MD_Exit, &InitParam) == UTOPIA_STATUS_SUCCESS)
    {
