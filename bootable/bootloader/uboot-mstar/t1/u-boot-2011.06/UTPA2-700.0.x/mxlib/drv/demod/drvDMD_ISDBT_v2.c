...
typedef struct _ISDBT_RESOURCE_PRIVATE
{
...
MS_U32 ISDBTIoctl(void* pInstance, MS_U32 u32Cmd, void* pArgs)
{
    ...
    psDMD_ISDBT_ResData = ((PISDBT_RESOURCE_PRIVATE)pResource)->sDMD_ISDBT_ResData;
    ...
    switch (u32Cmd)
    {
        ...
        case DMD_ISDBT_DRV_CMD_MD_Exit:
            ...
            u32Ret = psISDBTInstPri->fpExit(((PISDBT_INIT_PARAM)pArgs)->id);
            break;
