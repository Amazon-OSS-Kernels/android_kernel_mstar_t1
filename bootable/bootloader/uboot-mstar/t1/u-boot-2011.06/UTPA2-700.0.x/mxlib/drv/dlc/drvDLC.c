...
#endif
#include "../../../../mxlib/drv/xc/mdrv_xc_io.h"
...
#ifdef MSOS_TYPE_LINUX_KERNEL
extern MS_BOOL KDrv_DLC_SetTMOInfo(ST_KDRV_XC_TMO_INFO stTMOInfo);
#endif
MS_BOOL MDrv_DLC_SetTMOInfo(ST_DLC_TMO_INFO * pstDLCTMOInfo)
{
    ST_KDRV_XC_TMO_INFO stKdrvTmoInfo;
    memset(&stKdrvTmoInfo, 0, sizeof(ST_KDRV_XC_TMO_INFO));
    stKdrvTmoInfo.u16SrcMinRatio = pstDLCTMOInfo->u16SrcMinRatio;
    stKdrvTmoInfo.u16SrcMedRatio = pstDLCTMOInfo->u16SrcMedRatio;
    stKdrvTmoInfo.u16SrcMaxRatio = pstDLCTMOInfo->u16SrcMaxRatio;
    stKdrvTmoInfo.u16TgtMin = pstDLCTMOInfo->u16TgtMin;
    stKdrvTmoInfo.u16TgtMed = pstDLCTMOInfo->u16TgtMed;
    stKdrvTmoInfo.u16TgtMax = pstDLCTMOInfo->u16TgtMax;
    stKdrvTmoInfo.u16FrontSlopeMin = pstDLCTMOInfo->u16FrontSlopeMin;
    stKdrvTmoInfo.u16FrontSlopeMax = pstDLCTMOInfo->u16FrontSlopeMax;
    stKdrvTmoInfo.u16BackSlopeMin = pstDLCTMOInfo->u16BackSlopeMin;
    stKdrvTmoInfo.u16BackSlopeMax = pstDLCTMOInfo->u16BackSlopeMax;
    stKdrvTmoInfo.u16SceneChangeThrd = pstDLCTMOInfo->u16SceneChangeThrd;
    stKdrvTmoInfo.u16SceneChangeRatioMax = pstDLCTMOInfo->u16SceneChangeRatioMax;
    stKdrvTmoInfo.u8IIRRatio = pstDLCTMOInfo->u8IIRRatio;
    stKdrvTmoInfo.u8TMOTargetMode = pstDLCTMOInfo->u8TMOTargetMode;
    stKdrvTmoInfo.u16SDRPanelGain = pstDLCTMOInfo->u16SDRPanelGain;
    stKdrvTmoInfo.u16Smin = pstDLCTMOInfo->u16Smin;
    stKdrvTmoInfo.u16Smed = pstDLCTMOInfo->u16Smed;
    stKdrvTmoInfo.u16Smax = pstDLCTMOInfo->u16Smax;
    stKdrvTmoInfo.u16Tmin = pstDLCTMOInfo->u16Tmin;
    stKdrvTmoInfo.u16Tmed = pstDLCTMOInfo->u16Tmed;
    stKdrvTmoInfo.u16Tmax = pstDLCTMOInfo->u16Tmax;
#ifdef MSOS_TYPE_LINUX
    ...
    if (ioctl(s32FdDlcBle, MDRV_XC_IOC_DLCSETTMOINFO, &stKdrvTmoInfo))
    {
        DLC_PRINT("MDrv_DLC_SetTMOInfo send MDRV_XC_IOC_DLCSETTMOINFO fail!!!!\n");
        return FALSE;
    }
#elif MSOS_TYPE_LINUX_KERNEL
    KDrv_DLC_SetTMOInfo(stKdrvTmoInfo);
#endif
    return TRUE;
