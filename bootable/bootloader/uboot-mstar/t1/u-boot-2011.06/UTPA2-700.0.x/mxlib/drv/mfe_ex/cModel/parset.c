...
{
    MfeDrvMemFree(pConfig->active_sps, (const MS_S8*)("active_sps"));
    MfeDrvMemFree(pConfig->active_pps, (const MS_S8*)("active_pps"));
}
...
*/
...

    {
        ...
        if (pConfig->MfeCropInfo.crop_en == TRUE) {
            ...
            if (pConfig->nDispWidth != pConfig->nDispWidth)
