...
MS_BOOL MDrv_MMIO_Close(void)
{
    ...
    munmap(_virtPM_Bank, _u32PM_Bank_SIZE);
    munmap(_virtNonPM_Bank, _u32NonPM_Bank_SIZE );
    munmap(_virtFlash_Bank0, _u32Flash_Bank0_SIZE);
    munmap(_virtFRC_Bank, _u32FRC_Bank_SIZE);
    close(_s32MIOMapFd);
    _s32MIOMapFd = -1;
    return TRUE;
}
