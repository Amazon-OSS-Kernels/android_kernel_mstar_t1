    ...
    else if (QM_IsSourceDTV(enInputSourceType))
    {
        ...
        else if (QM_IsDTV_MPEG2(eWindow))
        {
            ...
            else
            {
                ...
                {
                    #if PQ_QM_DTV_4K2K
                    if(PQ_IS_4K2K_INPUT(u16Input_HSize,u16Input_VSize))  // 4K2K case
                    {
                        #if (PQ_QM_4K2K_60Hz)
...
MS_U16 QM_InputSourceToIndex_UFSC(PQ_WIN eWindow, MS_U8 enInputSourceType)
{
    MS_U16 u16SrcType = 0;
...
#endif
 if (MDrv_PQ_GetPQPathStatus(E_PQ_UFSC_4K_PATH, u16Input_HSize, u16Input_VSize))
    {
        if (bRGB444)
        {
