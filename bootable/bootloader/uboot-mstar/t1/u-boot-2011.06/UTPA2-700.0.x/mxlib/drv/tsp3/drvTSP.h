...
#define TSP_MAX_PVRSIGFLAG_NUM          6UL
...
typedef enum
{
    E_DRVTSP_REE_TO_TEE_MBX_MSG_NULL,
    E_DRVTSP_REE_TO_TEE_MBX_MSG_FW_LoadCode,                //None parameters
    E_DRVTSP_REE_TO_TEE_MBX_MSG_SET_VqBuf,                  //None parameters
    E_DRVTSP_REE_TO_TEE_MBX_MSG_SET_PvrBuf,                 //Param1: Engine id, Param2: Option 1 is reset buffer to 0
    E_DRVTSP_REE_TO_TEE_MBX_MSG_SET_FileinBuf,              //Param1: Engine id, Param2: Buf address, Param3: Buf size
    E_DRVTSP_REE_TO_TEE_MBX_MSG_GET_PvrWPtr                 //Param1: Engine id, Param2: Return Buf address
} TSP_REE_TO_TEE_MBX_MSG_TYPE;
