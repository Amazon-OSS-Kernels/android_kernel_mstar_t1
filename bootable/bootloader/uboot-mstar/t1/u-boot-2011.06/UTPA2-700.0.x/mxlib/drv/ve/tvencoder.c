...
void TVENCODERRegisterToUtopia(FUtopiaOpen ModuleType)
{
    ...
    UtopiaResourceObtain(pUtopiaTVEncoder, E_TVENCODER_POOL_ID_VE0, &psResource);
...
MS_U32 TVENCODERIoctl(void* pInstance, MS_U32 u32Cmd, void* pArgs)
{
    ...
    UtopiaResourceObtain(pUtopiaTVEncoder, E_TVENCODER_POOL_ID_VE0, &pstRes);
    ...
    switch(u32Cmd)
    {
        case E_MDRV_CMD_TVE_GetInfo:
        {
            ...
            memcpy(pGetInfo->pVE_DrvInfo,_MDrv_VE_GetInfo(),sizeof(VE_DrvInfo));
