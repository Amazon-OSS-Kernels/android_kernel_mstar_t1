...
#define MSIF_VIF_BUILDNUM     {'3','8'}
#define MSIF_VIF_CHANGELIST   {'0','1','4','9','7','8','2','3'}
#define MSIF_VIF_DASH          {'_'}
#define MSIF_VIF_DATE          {'1','6','0','1','0','6'}    // yymmdd
...
void VIF_Load_INIT_Parameter(void)
{
    //printf("\r\n =========== VIF_Load_INIT_Parameter ============ \n");

    VIF_InitData.VifTop = 3;
    VIF_InitData.VifIfBaseFreq = IF_FREQ_38_00;
    VIF_InitData.VifTunerStepSize = FREQ_STEP_62_5KHz;
    VIF_InitData.VifSawArch= 2;
...
MS_U32 VIF_SetPowerState(EN_POWER_MODE u16PowerState)
{
    ...
    if(bIsATV == TRUE)
    {
         ...
         {
             VIF_Load_INIT_Parameter();
             VIF_Init(&VIF_InitData, sizeof(VIF_InitData));
