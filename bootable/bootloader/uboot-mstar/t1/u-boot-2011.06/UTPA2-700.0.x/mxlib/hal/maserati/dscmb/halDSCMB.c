...
MS_BOOL _HAL_DSCMB_Mode(MS_U32 u32EngId, HAL_DSCMB_Type type)
{
    ...
    else if (E_HAL_DSCMB_TYPE_AES_CTR == type) // HDCP2
    {
        ...
        else if(u32EngId == 1)
        {
            ...
            //else
                REG16_W(REG_ESA1_CTRL, (REG16_R(REG_ESA1_CTRL) & ~REG_ESA1_CTRL_NEW_TSC_MASK) | REG_ESA1_CTRL_NEW_TSC_ODD);
        }
        else if(u32EngId == 2)
        {
            REG16_W(REG_CSA2_CTRL, 0x0);
            ...
            //else
                REG16_W(REG_ESA2_CTRL, (REG16_R(REG_ESA2_CTRL) & ~REG_ESA2_CTRL_NEW_TSC_MASK) | REG_ESA2_CTRL_NEW_TSC_ODD);
        }
        else
            return FALSE;
    }
