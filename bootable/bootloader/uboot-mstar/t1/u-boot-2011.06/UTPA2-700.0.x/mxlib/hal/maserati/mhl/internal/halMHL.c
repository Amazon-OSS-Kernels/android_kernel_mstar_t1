...
//
//**************************************************************************
void _mhal_mhl_HdmiBypassModeSetting(MS_U8 ucCbusSelect, MS_U8 ucImpedanceValue)
{
    switch(ucCbusSelect)
    {
#if(MHL_FUNCTION_SUPPORT_PORTA)
...
//
//**************************************************************************
void _mhal_mhl_Mhl24bitsModeSetting(MS_U8 ucCbusSelect, MS_U8 ucImpedanceValue)
{
    switch(ucCbusSelect)
    {
#if(MHL_FUNCTION_SUPPORT_PORTA)
...
void _mhal_mhl_SetECbusBISTTrigger(MS_BOOL bEnableFlag, MS_BOOL bBISTeCbusTxFlag, MS_BOOL bBISTeCbusRxFlag)
{
    if(bBISTeCbusTxFlag)
    {
        W2BYTEMSK(REG_MHL_ECBUS_2A, bEnableFlag? BIT(12): BIT(13), BMASK(13:12));
    }
...
{
    W2BYTEMSK(REG_MHL_ECBUS_7A, bEnableFlag? BIT(5)| BMASK(3:0): 0, BIT(5)| BMASK(3:0));
...
void mhal_mhl_CablePlugProc(MS_U8 ucCbusSelect, MS_U8 ucImpedanceValue)
{
    ...
    _mhal_mhl_Mhl24bitsModeSetting(ucCbusSelect, ucImpedanceValue);
...
void mhal_mhl_CableRemoveProc(MS_U8 ucCbusSelect, MS_U8 ucImpedanceValue)
{
    ...
    _mhal_mhl_HdmiBypassModeSetting(ucCbusSelect, ucImpedanceValue);
