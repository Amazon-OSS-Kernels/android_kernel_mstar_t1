...
void HAL_SetSCFEMIUIPSel(MVOP_SCIPSel *stIPSel)
{
    ...
    HAL_WriteRegBit(REG_MIU0_PROTECT, 1, MVOP_MIU_IP_SEL);
    HAL_WriteRegBit(REG_MIU1_PROTECT, 1, MFDEC0_MIU_IP_SEL);
    HAL_WriteRegBit(REG_MIU2_PROTECT, 1, MFDEC1_MIU_IP_SEL);
    ...
    HAL_WriteRegBit(REG_MIU0_PROTECT, 0, MVOP_MIU_IP_SEL);
    HAL_WriteRegBit(REG_MIU1_PROTECT, 0, MVOP_MIU_IP_SEL);
    HAL_WriteRegBit(REG_MIU2_PROTECT, 0, MVOP_MIU_IP_SEL);
}
