...
#if (PQ_GRULE_NR_ENABLE) || (PQ_GRULE_OSD_BW_ENABLE) || (PQ_GRULE_MPEG_NR_ENABLE) || (PQ_GRULE_FILM_MODE_ENABLE) || (PQ_GRULE_ULTRAT_CLEAR_ENABLE) || (PQ_GRULE_PTP_ENABLE) || (PQ_GRULE_GAME_MODE_ENABLE) || (PQ_GRULE_DS_PARAMETERS_ENABLE) || (PQ_GRULE_HDR_ENABLE)
typedef enum
{
...
#define PQ_GRULE_HDR_NUM_Main 1
#define PQ_GRULE_HDR_LVL_NUM_Main 1
#endif
