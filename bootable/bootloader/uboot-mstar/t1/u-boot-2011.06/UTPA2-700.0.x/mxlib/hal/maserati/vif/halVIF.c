...
#define VIF_IS_EQ_IIR           1   // 0:FIR ; 1:IIR
...
void msVifAdcInitial(void)
{
    ...
    // Analog setting
    RIU_WriteByte(0x128AEL, 0x00);                    // Enable LDOS
    ...
    RIU_WriteByte(0x12818L, 0x00);                 // ADC power down
...
void msVifInitial(void)
{
    ...
    msWriteByte(FIRMWARE_VERSION_H, 0x10);                          // 01/16 (mm/yy)  firmware version control
