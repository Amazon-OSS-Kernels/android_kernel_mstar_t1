...
// MFC
    ...
    MDrv_WriteByteMask( REG_FRC_BK22C_C4  , 0x3c, 0xFF); // reg_hr_miu_req
...
// T3D
    MDrv_WriteByteMask( REG_FSC_BKC6_C0, 0x31, 0xff); // reg_pipe_guard_cycle_pb
    MDrv_WriteByteMask( REG_FSC_BKC6_C2, 0x00, 0xff); // reg_ln_width
    MDrv_WriteByteMask( REG_FSC_BKC6_C3, 0x0f, 0x3f); // reg_ln_width
    MDrv_WriteByteMask( REG_FSC_BKC6_C4, 0x70, 0xff); // reg_col_height
    MDrv_WriteByteMask( REG_FSC_BKC6_C5, 0x08, 0x1f); // reg_col_height
    MDrv_WriteByteMask( REG_FSC_BKC6_C5, 0x00, 0x60); // reg_lb_mode_control
    MDrv_WriteByteMask( REG_FSC_BKC6_C6, 0x01, 0x01); // reg_srclb_en
    MDrv_WriteByteMask( REG_FSC_BKC6_C6, 0x02, 0x02); // reg_depthlb_en
    ...
    MDrv_WriteByteMask( REG_FSC_BKC6_D0, 0x04, 0x04); // reg_lr_control_r
    MDrv_WriteByteMask( REG_FSC_BKC6_10, 0x10, 0x10); // reg_mtv_bypass_en
    MDrv_WriteByteMask( REG_FSC_BKC6_C5, 0x40, 0x40); // reg_lineswap
// FO_HSU
