...
INTERFACE void MHal_FRC_IPM_SetBaseAddr(void *pInstance, MS_U32 addr, MS_U32 u32FrameYcout, MS_U16 u16FB_YcountLinePitch, MS_U8 u8MirrorMode );
INTERFACE void MHal_FRC_IPM_R_SetBaseAddr(void *pInstance, MS_U32 addr);
...
INTERFACE void MHal_FRC_OPM_SetBaseAddr(void *pInstance, MS_U32 addr, MS_U32 u32FrameYcout);
INTERFACE void MHal_FRC_OPM_R_SetBaseAddr(void *pInstance, MS_U32 addr);
...
INTERFACE void MHal_FRC_ME1_SetBaseAddr(void *pInstance, MS_U32 addr, MS_U32 u32Size);
INTERFACE void MHal_FRC_ME2_SetBaseAddr(void *pInstance, MS_U32 addr, MS_U32 u32Size);
#define MHal_FRC_2D3D_Render_SetBaseAddr(args...)
#define MHal_FRC_2D3D_Render_Detection_SetBaseAddr(args...)
INTERFACE void MHal_FRC_Halo_SetBaseAddr(void *pInstance, MS_U32 addr, MS_U32 u32Size);
...
INTERFACE MS_BOOL MHal_FRC_IsForce4K2KToFSC(void *pInstance, SCALER_WIN eWindow);
