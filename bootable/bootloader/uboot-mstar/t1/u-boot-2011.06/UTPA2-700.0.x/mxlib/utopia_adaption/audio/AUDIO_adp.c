...
MS_U32 AUDIO_adp_Ioctl(void* pInstanceTmp, MS_U32 u32Cmd, void* const pArgs)
{
    ...
    switch(u32Cmd)
    {
        ...
        case MApi_CMD_AUDIO_Copy_Parameter:
            ...
            UADP_SDT_BGN (&spt_AUDIO_tmp2[0], pCopyParamterDes->size);
            UADP_SDT_FIN(&spt_AUDIO_tmp2[1]);

            UADP_SDT_BGN (&spt_AUDIO_tmp[0], sizeof(AUDIO_ST_COPY_PARAMETER));
            UADP_SDT_KIND(&spt_AUDIO_tmp[1], AUDIO_ST_COPY_PARAMETER, UADP_SDT_P2N, type, spt_AUDIO_tmp1);
            UADP_SDT_KIND(&spt_AUDIO_tmp[2], AUDIO_ST_COPY_PARAMETER, UADP_SDT_P2N, Parameter_ptr, spt_AUDIO_tmp2);
        ...
        case MApi_CMD_AUDIO_CheckInputRequest:
			...
			UADP_SDT_KIND(&spt_AUDIO_tmp[1], AUDIO_ST_CHECK_INPUT_REQ, UADP_SDT_P2N, pU32WrtBytes, spt_MS_U32);
			UADP_SDT_FIN(&spt_AUDIO_tmp[2]);
        ...
        case MApi_CMD_AUDIO_MM_CheckInputRequest:
			...
			UADP_SDT_KIND(&spt_AUDIO_tmp[1], AUDIO_ST_MM_CHECK_INPUT_REQ, UADP_SDT_P2N, pU32WrtBytes, spt_MS_U32);
			UADP_SDT_FIN(&spt_AUDIO_tmp[2]);
        ...
        case MApi_CMD_AUDIO_UNI_CheckDecodeDone:
			...
			UADP_SDT_KIND(&spt_AUDIO_tmp[1], AUDIO_ST_UNI_CHECK_DECODEDONE, UADP_SDT_P2N, pU32WrtBytes, spt_MS_U32);
			UADP_SDT_FIN(&spt_AUDIO_tmp[2]);
