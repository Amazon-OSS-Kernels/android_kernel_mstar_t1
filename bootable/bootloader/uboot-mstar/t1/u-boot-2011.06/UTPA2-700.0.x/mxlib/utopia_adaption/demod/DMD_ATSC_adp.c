...
UADP_STRUCT_POINTER_TABLE spt_DMD_ATSC_BOOL_VAL[5];
UADP_STRUCT_POINTER_TABLE spt_DMD_ATSC_U8_VAL[5];
UADP_STRUCT_POINTER_TABLE spt_DMD_ATSC_U16_VAL[5];
UADP_STRUCT_POINTER_TABLE spt_DMD_ATSC_S16_VAL[5];
...
UADP_STRUCT_POINTER_TABLE spt_DMD_ATSC_InitData[5];
...
{
    printk("ATSC_adp_Init\n");

    UADP_SPT_BGN(&spt_DMD_ATSC_DBG_LEVEL_PARAM[0], sizeof(ATSC_DBG_LEVEL_PARAM));
    UADP_SPT_FIN(&spt_DMD_ATSC_DBG_LEVEL_PARAM[1]);

    UADP_SPT_BGN(&spt_DMD_ATSC_Info[0], sizeof(DMD_ATSC_Info));
    UADP_SPT_FIN(&spt_DMD_ATSC_Info[1]);
    UADP_SPT_BGN(&spt_DMD_ATSC_GET_INFO_PARAM[0], sizeof(ATSC_GET_INFO_PARAM));
    UADP_SPT_NXT(&spt_DMD_ATSC_GET_INFO_PARAM[1], ATSC_GET_INFO_PARAM, pInfo, spt_DMD_ATSC_Info);
    UADP_SPT_FIN(&spt_DMD_ATSC_GET_INFO_PARAM[2]);

    UADP_SPT_BGN(&spt_DMD_ATSC_InitData[0], sizeof(DMD_ATSC_InitData));
    UADP_SPT_NXT(&spt_DMD_ATSC_InitData[1], DMD_ATSC_InitData, u8DMD_ATSC_DSPRegInitExt, spt_DMD_ATSC_U8_VAL);
    UADP_SPT_NXT(&spt_DMD_ATSC_InitData[2], DMD_ATSC_InitData, u8DMD_ATSC_InitExt, spt_DMD_ATSC_U8_VAL);
    UADP_SPT_FIN(&spt_DMD_ATSC_InitData[3]);
    UADP_SPT_BGN(&spt_DMD_ATSC_INIT_PARAM[0], sizeof(ATSC_INIT_PARAM));
    UADP_SPT_NXT(&spt_DMD_ATSC_INIT_PARAM[1], ATSC_INIT_PARAM, pDMD_ATSC_InitData, spt_DMD_ATSC_InitData);
    UADP_SPT_FIN(&spt_DMD_ATSC_INIT_PARAM[2]);
