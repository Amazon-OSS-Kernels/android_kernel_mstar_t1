...
UADP_STRUCT_POINTER_TABLE spt_DMD_DTMB_BOOL_VAL[5];
UADP_STRUCT_POINTER_TABLE spt_DMD_DTMB_U8_VAL[5];
UADP_STRUCT_POINTER_TABLE spt_DMD_DTMB_U16_VAL[5];
UADP_STRUCT_POINTER_TABLE spt_DMD_DTMB_S16_VAL[5];
UADP_STRUCT_POINTER_TABLE spt_DMD_DTMB_FUNC_PTR_VAL[5];
...
MS_U32 DTMB_adp_Init(FUtopiaIOctl* pIoctl)
{
    ...
    UADP_SPT_BGN(&spt_DMD_DTMB_BOOL_VAL[0], 1);
    UADP_SPT_FIN(&spt_DMD_DTMB_BOOL_VAL[1]);
    UADP_SPT_BGN(&spt_DMD_DTMB_U8_VAL[0], 1);
    UADP_SPT_FIN(&spt_DMD_DTMB_U8_VAL[1]);
    UADP_SPT_BGN(&spt_DMD_DTMB_U16_VAL[0], 2);
    UADP_SPT_FIN(&spt_DMD_DTMB_U16_VAL[1]);
    UADP_SPT_BGN(&spt_DMD_DTMB_S16_VAL[0], 2);
    UADP_SPT_FIN(&spt_DMD_DTMB_S16_VAL[1]);
    UADP_SPT_BGN(&spt_DMD_DTMB_FUNC_PTR_VAL[0], 8);
    UADP_SPT_FIN(&spt_DMD_DTMB_FUNC_PTR_VAL[1]);
    ...
    UADP_SDT_KIND(&spt_DMD_DTMB_InitData[1], DMD_DTMB_InitData, UADP_SDT_P2N, u8DMD_DTMB_DSPRegInitExt, spt_DMD_DTMB_FUNC_PTR_VAL);
    UADP_SDT_KIND(&spt_DMD_DTMB_InitData[2], DMD_DTMB_InitData, UADP_SDT_P2N, u8DMD_DTMB_InitExt, spt_DMD_DTMB_FUNC_PTR_VAL);
    UADP_SDT_KIND(&spt_DMD_DTMB_InitData[3], DMD_DTMB_InitData, UADP_SDT_AT, I2C_WriteBytes, spt_DMD_DTMB_FUNC_PTR_VAL);
    UADP_SDT_KIND(&spt_DMD_DTMB_InitData[4], DMD_DTMB_InitData, UADP_SDT_AT, I2C_ReadBytes, spt_DMD_DTMB_FUNC_PTR_VAL);
