...
UADP_STRUCT_POINTER_TABLE spt_DMD_ISDBT_BOOL_VAL[5];
UADP_STRUCT_POINTER_TABLE spt_DMD_ISDBT_U8_VAL[5];
UADP_STRUCT_POINTER_TABLE spt_DMD_ISDBT_U16_VAL[5];
UADP_STRUCT_POINTER_TABLE spt_DMD_ISDBT_S16_VAL[5];
...
UADP_STRUCT_POINTER_TABLE spt_DMD_ISDBT_InitData[5];
...
MS_U32 DMD_ISDBT_adp_Init(FUtopiaIOctl* pIoctl)
{
    ...
    UADP_SPT_BGN(&spt_DMD_ISDBT_Info[0], sizeof(DMD_ISDBT_Info));
    UADP_SPT_FIN(&spt_DMD_ISDBT_Info[1]);
    UADP_SPT_BGN(&spt_DMD_ISDBT_GET_INFO_PARAM[0], sizeof(ISDBT_GET_INFO_PARAM));
    UADP_SPT_NXT(&spt_DMD_ISDBT_GET_INFO_PARAM[1], ISDBT_GET_INFO_PARAM, pInfo, spt_DMD_ISDBT_Info);
    UADP_SPT_FIN(&spt_DMD_ISDBT_GET_INFO_PARAM[2]);

    UADP_SPT_BGN(&spt_DMD_ISDBT_InitData[0], sizeof(DMD_ISDBT_InitData));
    UADP_SPT_NXT(&spt_DMD_ISDBT_InitData[1], DMD_ISDBT_InitData, u8DMD_ISDBT_DSPRegInitExt, spt_DMD_ISDBT_U8_VAL);
    UADP_SPT_NXT(&spt_DMD_ISDBT_InitData[2], DMD_ISDBT_InitData, u8DMD_ISDBT_InitExt, spt_DMD_ISDBT_U8_VAL);
    UADP_SPT_FIN(&spt_DMD_ISDBT_InitData[1]);
    UADP_SPT_BGN(&spt_DMD_ISDBT_INIT_PARAM[0], sizeof(ISDBT_INIT_PARAM));
    UADP_SPT_NXT(&spt_DMD_ISDBT_INIT_PARAM[1], ISDBT_INIT_PARAM, pDMD_ISDBT_InitData, spt_DMD_ISDBT_InitData);
    UADP_SPT_FIN(&spt_DMD_ISDBT_INIT_PARAM[2]);
