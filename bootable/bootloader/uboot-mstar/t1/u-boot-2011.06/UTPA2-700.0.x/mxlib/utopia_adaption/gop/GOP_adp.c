...
UADP_SPT_NAMEnNXT_DEF(GOP_GETCAPS_GOP_MUX_MuxCap_MuxProrityArray,0);
UADP_SPT_NAMEnNXT_DEF(GOP_GETCAPS_GOP_MUX_MuxCap,1);
UADP_SPT_NAMEnNXT_DEF(GOP_GETCAPS_GOP_MUX,2);
...
MS_U32 GOP_adp_Init(FUtopiaIOctl* pIoctl)
{
    ...
    UADP_SPT_NAME0NXT(GOP_GETCAPS_GOP_MUX_MuxCap_MuxProrityArray,MS_U8);
    UADP_SPT_NAME1NXT(GOP_GETCAPS_GOP_MUX_MuxCap,ST_GOP_MUX_CAP,pu8MuxProrityArray,GOP_GETCAPS_GOP_MUX_MuxCap_MuxProrityArray);
