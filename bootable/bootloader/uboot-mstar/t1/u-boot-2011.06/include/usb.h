...
#define ENABLE_SECOND_EHC
	...
	(ENABLE_KANO) || (ENABLE_MESSI) || (ENABLE_MASERATI) || (ENABLE_CURRY) || \
	(ENABLE_MACAN) || (ENABLE_MAXIM) || (ENABLE_KASTOR)
#define ENABLE_THIRD_EHC
	...
	(ENABLE_CELTICS) || (ENABLE_MONET) || (ENABLE_MUNICH) || (ENABLE_MANHATTAN) || \
	(ENABLE_KANO) || (ENABLE_MASERATI) || (ENABLE_CURRY) || (ENABLE_MACAN) || (ENABLE_MAXIM)
#define ENABLE_FOURTH_EHC
#endif

#if (ENABLE_MONACO) || (ENABLE_MIAMI) || (ENABLE_MUJI) || (ENABLE_CELTICS) || \
	(ENABLE_MANHATTAN) || (ENABLE_KANO) || (ENABLE_MASERATI) || (ENABLE_CURRY) || \
	(ENABLE_MAXIM)
