...
TftpStart(void)
{
	...
	char sRemoteIPStr[32], sOurIPStr[32];
	ip_to_string(TftpRemoteIP, sRemoteIPStr);
	ip_to_string(NetOurIP, sOurIPStr);
	printf("TFTP from server %s; our IP address is %s", sRemoteIPStr, sOurIPStr);
