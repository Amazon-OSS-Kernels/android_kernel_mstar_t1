...
#elif (CHIP_FAMILY_TYPE == CHIP_FAMILY_KERES) || (CHIP_FAMILY_TYPE == CHIP_FAMILY_KRIS) || (CHIP_FAMILY_TYPE == CHIP_FAMILY_K1P)
...
#elif (CHIP_FAMILY_TYPE == CHIP_FAMILY_KRITI) || (CHIP_FAMILY_TYPE == CHIP_FAMILY_K5AP)
    #define NON_PM_RIU_BASE     0xBF200000
    #define CPU_CLOCK_REG       0x10C34
    #define MIPS_CLOCK_FREQ     ((RegReadByte(NON_PM_RIU_BASE, CPU_CLOCK_REG)*6))*1000000
