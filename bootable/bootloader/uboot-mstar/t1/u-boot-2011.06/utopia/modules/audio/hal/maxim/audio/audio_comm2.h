...
*   Version Control
*********************************************************/
#define  system_version_num              0x880D98
...
*********************************************************/
    ...
    #define BASSBOOST_EN                            1               // Super Bass
...
************************************************/
    ...
    /* SND DSP PM vars */
        /* common */
            ...
            #define DSP2PmAddr_mainAudioDelay       (DSP2_PM_MAIN_ADDR +    0x01)
            #define DSP2PmAddr_spdifDelay           (DSP2_PM_MAIN_ADDR +    0x02)
            #define DSP2PmAddr_hpDelay              (DSP2_PM_MAIN_ADDR +    0x03)
            #define DSP2PmAddr_hdmiNonPcmSts        (DSP2_PM_MAIN_ADDR +    0x04)
            #define DSP2PmAddr_btFrameSize          (DSP2_PM_MAIN_ADDR +    0x05)
            #define DSP2PmAddr_STest_Report         (DSP2_PM_MAIN_ADDR +    0x06)
            #define DSP2PmAddr_ipSecurity           (DSP2_PM_MAIN_ADDR +    0x07)
            #define DSP2PmAddr_ch5InputDelay        (DSP2_PM_MAIN_ADDR +    0x08)
            #define DSP2PmAddr_ch6InputDelay        (DSP2_PM_MAIN_ADDR +    0x09)
            #define DSP2PmAddr_multiChInputDelay    (DSP2_PM_MAIN_ADDR +    0x0A)

          #if ((PEQ_EN)||(FAKE_DMPM))
            #define DSP2PmAddr_peq48KCoeffAddr      (DSP2_PM_MAIN_ADDR +    0x10)   // len 40
            #define DSP2PmAddr_peq32KCoeffAddr      (DSP2PmAddr_peq48KCoeffAddr )
            #define DSP2PmAddr_peqscale48KAddr      (DSP2_PM_MAIN_ADDR +    0x38)   // len 8
            #define DSP2PmAddr_peqbandEnAddr        (DSP2_PM_MAIN_ADDR +    0x40)   // len 1
            #define DSP2PmAddr_peqbandDoubleAddr    (DSP2_PM_MAIN_ADDR +    0x41)   // len 1
          #endif // end #if (PEQ_EN)
          #if ((HPF_EN)||(FAKE_DMPM))
            #define DSP2PmAddr_hpf48KCoeffAddr      (DSP2_PM_MAIN_ADDR +    0x42)   // len 5
          #endif // end #if (HPF_EN)
          #if ((BASS_TREBLE_EN)||(FAKE_DMPM))
            #define DSP2PmAddr_toneSelectAddr       (DSP2_PM_MAIN_ADDR +    0x47)   // len 1
            #define DSP2PmAddr_bass48KCoeffAddr     (DSP2_PM_MAIN_ADDR +    0x48)   // len 5
            #define DSP2PmAddr_bassscale48KAddr     (DSP2_PM_MAIN_ADDR +    0x4D)   // len 1
            #define DSP2PmAddr_treble48KCoeffAddr   (DSP2_PM_MAIN_ADDR +    0x4E)   // len 5
            #define DSP2PmAddr_treblescale48KAddr   (DSP2_PM_MAIN_ADDR +    0x53)   // len 1
          #endif // end #if (BASS_TREBLE_EN)
            #define DSP2PmAddr_SPK_OutChannel       (DSP2_PM_MAIN_ADDR +    0x54)   // len 1
            #define DSP2PmAddr_HP_OutChannel        (DSP2_PM_MAIN_ADDR +    0x55)   // len 1
          #if ((EASE_EN)||(FAKE_DMPM))
            #define DSP2PmAddr_VolEaseAddr          (DSP2_PM_MAIN_ADDR +    0x56)   // len 9
          #endif // end #if (EASE_EN)
            #define DSP2PmAddr_VolFadingStep1       (DSP2_PM_MAIN_ADDR +    0x5F)   // len 1
            #define DSP2PmAddr_VolFadingStep2       (DSP2_PM_MAIN_ADDR +    0x60)   // len 1
            #define DSP2PmAddr_VolFadingCtrl        (DSP2_PM_MAIN_ADDR +    0x61)   // len 1
          #if ((SWEEP_TONE_EN)||(FAKE_DMPM))
            #define DSP2PmAddr_sinGainAddr          (DSP2_PM_MAIN_ADDR +    0x62)   // len 1
          #endif // end #if (SWEEP_TONE_EN)
    ...
    /* SND DSP DM vars */
        ...
        /* basic sound effect */
          ...
          #endif // end #if (SWEEP_TONE_EN)
            #define DSP2DmAddr_hdmi_clockCheck_muteCnt_ch5  (DSP2_DM_MAIN_ADDR + 0x0884)
            #define DSP2DmAddr_hdmi_clockCheck_muteCnt_ch6  (DSP2_DM_MAIN_ADDR + 0x0885)
            #define DSP2DmAddr_hdmi_eventCheck_muteCnt_ch5  (DSP2_DM_MAIN_ADDR + 0x0886)
            #define DSP2DmAddr_hdmi_eventCheck_muteCnt_ch6  (DSP2_DM_MAIN_ADDR + 0x0887)

        /* report HDMI PAPB lock */
            #define DSP2DmAddr_hdmi_npcm_lock           (DSP2_DM_MAIN_ADDR + 0x0888)

        /* multi-channel DMA reader volume */
          #if ((MCH_SW_DMA_RDR_EN)||(FAKE_DMPM))
            #define DSP2DmAddr_mch_swDmaRdr_vol1        (DSP2_DM_MAIN_ADDR + 0x0889)
            #define DSP2DmAddr_mch_swDmaRdr_vol2        (DSP2_DM_MAIN_ADDR + 0x088A)
          #endif // end #if (MCH_SW_DMA_RDR_EN)
...
*************************************************/
    ...
    ************************************************/
    ...
    #define M2S_MBOX_MCH_SW_DMA_READER_DDR_WtPtr    MB_2D3C
    #define M2S_MBOX_MCH_SW_DMA_READER_DDR_Ctrl     MB_2D3E
    ...
    ************************************************/
    ...
    #define S2M_MBOX_MCH_SW_DMA_READER_DDR_Level    MB_2DE8
...
*************************************************/
	...
	/* standalone DTST PCM Buffer */
        //#define DSP2_DDE_PCM_DRAM_BASE              (DSP2_DM_PREFETCH_DRAM_BASE+0x400)      // AC3 Encode base address
        //#define DSP2_DDE_PCM_DRAM_SIZE              (0xBFF)           // 48KB
        .const DSP2_DTST_PCM_DRAM_BASE               = (OFFSET_DSP_DTST_MCHOUT_DRAM_ADDR / BYTES_IN_MIU_LINE);      // AC3 Encode base address
        .const DSP2_DTST_PCM_DRAM_SIZE               = ((DSP_DTST_MCHOUT_DRAM_SIZE / BYTES_IN_MIU_LINE) - 1);       // 54kB
    /* COMMON DRAM */
        ...
        /* Multi-channel Software DMA */
            #if(MCH_SW_DMA_READER_DRAM_SIZE>0)
            .const DSP2_MCH_SW_DMA_READER_DRAM_BASE     = (DSP2_TO_COMMON_DRAM_OFFSET + (OFFSET_MCH_SW_DMA_READER_DRAM_BASE / BYTES_IN_MIU_LINE));
            .const DSP2_MCH_SW_DMA_READER_DRAM_SIZE     = ((MCH_SW_DMA_READER_DRAM_SIZE / BYTES_IN_MIU_LINE) - 1);
            #endif
...
*************************************************/
    ...
    #define General_DSP_IDMA_CMD_Number             15              // just info this chip nubmer of DSP_IDMA can support, (no any purpose) need sync with HW spec
        ...
        #define MCH_SW_DMARDR_DMA_CTRL          DSPDMA13_DMA_CTRL
...
*************************************************/
    ...
    /* General delay buffer template */
        ...
        #if ((MULTI_CH_INPUT_DELAY_EN)||(FAKE_DMPM))
        ...
        #endif // end #if (MULTI_CH_INPUT_DELAY_EN)
    ...
    /* SW DMA */
        #if ((SW_DMA_RDR_EN) || (MCH_SW_DMA_RDR_EN)||(FAKE_DMPM))
        .const SW_DMA_CTRL_RESET_BIT              = 0;
        .const SW_DMA_CTRL_START_BIT              = 1;
        .const SW_DMA_CTRL_CIRCL_BIT              = 2;
        #endif // end #if ((SW_DMA_RDR_EN) || (MCH_SW_DMA_RDR_EN))
    ...
    /* Multi-channel SW DMA */
        #if ((MCH_SW_DMA_RDR_EN)||(FAKE_DMPM))
        .const MCH_SW_DMA_WORDSIZE                = 32*3;
        .const MCH_SW_DMA_LINESIZE                = SW_DMA_WORDSIZE*2/BYTES_IN_MIU_LINE;
        #endif // end #if (MCH_SW_DMA_RDR_EN)
...
********************************************************************/
    ...
    /* PCM output port */
      ...
      #endif // end #if (R2_DEC_ISR1_EN)

      #if ((R2_DEC_ISR2_EN)||(FAKE_DMPM))
