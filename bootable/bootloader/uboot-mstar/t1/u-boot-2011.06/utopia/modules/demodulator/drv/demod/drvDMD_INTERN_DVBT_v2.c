...
//typedef MS_BOOL                   (*IOCTL_DVBT_GetSNR)(float *);
//typedef MS_BOOL                   (*IOCTL_DVBT_GetPostViterbiBer)(float *);
...
/*bryan temp mark*/
#if(0)
MS_BOOL DMD_DVBT_GetSNR(float *fSNR)
{
    DMD_LOCK();
...
MS_BOOL DMD_DVBT_GetPostViterbiBer(float *ber)
{
    MS_BOOL bRet;
...
*/
        ...
        case DMD_DVBT_DRV_CMD_GetSNR:
            ...
            bRet = psDVBTInstPri->fpDVBTGetSNR(((PDVBT_GetSNR_PARAM)pArgs)->fSNR);
        ...
        case DMD_DVBT_DRV_CMD_GetPostViterbiBer:
            ...
            bRet = psDVBTInstPri->fpDVBTGetPostViterbiBer(((PDVBT_GetPostViterbiBer_PARAM)pArgs)->ber);
