...
#define DVBC_FS         48000  //45474   //24000
...
//MS_BOOL INTERN_DVBC_GetCurrentSymbolRateOffset(MS_U32 *pData);
...
MS_BOOL INTERN_DVBC_Get_FreqOffset(MS_U32 *config_Fc_reg, MS_U32 *Fc_over_Fs_reg, MS_U16 *Cfo_offset_reg, MS_U8 u8BW)
{
    ...
    *config_Fc_reg = (*config_Fc_reg<<8)|reg;
    ...
    status &= MDrv_SYS_DMD_VD_MBX_ReadReg(TDF_REG_BASE + 0x57, &reg);
    *Fc_over_Fs_reg = reg;
    status &= MDrv_SYS_DMD_VD_MBX_ReadReg(TDF_REG_BASE + 0x56, &reg);
    *Fc_over_Fs_reg = (*Fc_over_Fs_reg<<8)|reg;
    status &= MDrv_SYS_DMD_VD_MBX_ReadReg(TDF_REG_BASE + 0x55, &reg);
    *Fc_over_Fs_reg = (*Fc_over_Fs_reg<<8)|reg;
    status &= MDrv_SYS_DMD_VD_MBX_ReadReg(TDF_REG_BASE + 0x54, &reg);
    *Fc_over_Fs_reg = (*Fc_over_Fs_reg<<8)|reg;
