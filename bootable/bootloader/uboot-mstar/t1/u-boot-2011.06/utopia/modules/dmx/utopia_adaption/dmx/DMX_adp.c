...
MS_U32 DMX_adp_Ioctl(void* pInstanceTmp, MS_U32 u32Cmd, void* const pArgs)
{
    ...
    MS_S8                           buffer_arg[128];
    MS_S8                           buffer_array0[128];
    MS_S8                           buffer_array1[128];
    MS_S8                           buffer_array2[32];
    MS_U32                          u32NextPtr = 0, u32NextPtrOut = 0, u32NextPtr1 = 0, u32NextPtr2 = 0;
