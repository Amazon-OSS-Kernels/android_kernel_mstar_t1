...
UADP_STRUCT_POINTER_TABLE spt_DSCMB_pu8Buf[2];
...
UADP_STRUCT_POINTER_TABLE spt_DSCMB_KLadder_AtomicExec_KLCfg[SPT_TYPE_C_SIZE];
UADP_STRUCT_POINTER_TABLE spt_DSCMB_KLadder_AtomicExec_KLCfg_Lv2[SPT_TYPE_C_SIZE];
UADP_STRUCT_POINTER_TABLE spt_DSCMB_KLadder_AtomicExec_KLCfg_Lv3[SPT_TYPE_C_SIZE];
UADP_STRUCT_POINTER_TABLE spt_DSCMB_KLadder_AtomicExec_KLCfg_Lv4[SPT_TYPE_C_SIZE];
UADP_STRUCT_POINTER_TABLE spt_DSCMB_KLadder_AtomicExec_KLCfg_Lv5[SPT_TYPE_C_SIZE];
UADP_STRUCT_POINTER_TABLE spt_DSCMB_KLadder_AtomicExec_u32Status[SPT_TYPE_A_SIZE];
...
MS_U32 DSCMB_adp_Init(FUtopiaIOctl* pIoctl)
{
    ...
    UADP_SPT_NAME5NXT_TYPE(spt_DSCMB_KLadder_ETSI, DSCMB_KL_ETSI,
                           KLCfg,       spt_DSCMB_KLadder_AtomicExec_KLCfg,
                           ACPU_Out,    spt_DSCMB_pu8Buf16,
                           pu8Nonce,    spt_DSCMB_pu8Buf16,
                           pu8Response, spt_DSCMB_pu8Buf16,
                           u32Status,   spt_DSCMB_KLadder_AtomicExec_u32Status);
    ...
    //BOTTOM
    UADP_SPT_NAME2NXT_TYPE(spt_DSCMB_KLadder_AtomicExec_KLCfg, DSCMB_KLCfg_All,
                           u8KeyACPU,  spt_DSCMB_pu8Buf16,
                           pu8KeyKLIn, spt_DSCMB_pu8Buf16);
    UADP_SPT_NAME2NXT_TYPE(spt_DSCMB_KLadder_AtomicExec_KLCfg_Lv2, DSCMB_KLCfg_All,
                           u8KeyACPU,  spt_DSCMB_pu8Buf16,
                           pu8KeyKLIn, spt_DSCMB_pu8Buf32);
    UADP_SPT_NAME2NXT_TYPE(spt_DSCMB_KLadder_AtomicExec_KLCfg_Lv3, DSCMB_KLCfg_All,
                           u8KeyACPU,  spt_DSCMB_pu8Buf16,
                           pu8KeyKLIn, spt_DSCMB_pu8Buf48);
    UADP_SPT_NAME2NXT_TYPE(spt_DSCMB_KLadder_AtomicExec_KLCfg_Lv4, DSCMB_KLCfg_All,
                           u8KeyACPU,  spt_DSCMB_pu8Buf16,
                           pu8KeyKLIn, spt_DSCMB_pu8Buf64);
    UADP_SPT_NAME2NXT_TYPE(spt_DSCMB_KLadder_AtomicExec_KLCfg_Lv5, DSCMB_KLCfg_All,
                           u8KeyACPU,  spt_DSCMB_pu8Buf16,
                           pu8KeyKLIn, spt_DSCMB_pu8Buf80);

    UADP_SPT_NAME0NXT_TYPE(spt_DSCMB_KLadder_AtomicExec_u32Status, DSCMB_KL_Status);
...
MS_U32 DSCMB_adp_Ioctl(void* pInstanceTmp, MS_U32 u32Cmd, void* const pArgs)
{
    ...
    DSCMB_KL_ATOMICEXEC* pKLAtomicArgs;
    DSCMB_KL_ETSI* pKLETSIArgs;
    switch(u32Cmd)
    {
        ...
        case E_MDRV_CMD_DSCMB_KLadder_AtomicExec:
            pKLAtomicArgs = (DSCMB_KL_ATOMICEXEC *)pArgs;
        ...
        case E_MDRV_CMD_DSCMB_KLadder_ETSI:
            pKLETSIArgs = (DSCMB_KL_ETSI *)pArgs;
