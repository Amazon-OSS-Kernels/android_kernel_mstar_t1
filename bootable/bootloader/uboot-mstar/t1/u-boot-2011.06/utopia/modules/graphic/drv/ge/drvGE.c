                                                           ...
                                                           /*Step 1: Check HWSemaphore*/\
                                                               ...
                                                               {   \
                                                                   ...
                                                                   {\
                                                                       ...
                                                                       GE_D_DBUG("\33[0;31m [Entry While][%s][%d]GE_GetHWSemphoreID=%tx; pGECtxLocal->u32GESEMID=%tx, s32GELock=0x%tx\33[m;\n",__FUNCTION__,__LINE__, (ptrdiff_t)GE_GetHWSemaphoreID, (ptrdiff_t)pGECtxLocal->u32GESEMID,pGECtxLocal->s32GELock);\
                                                                    ...
                                                                    GE_D_DBUG("\33[0;31m [%s][%d] Release GE Mutex Fail \33[m;\n",__FUNCTION__,__LINE__);\
                                                                     ...
                                                                     {  \
                                                                         ...
                                                                         {\
                                                                            ...
                                                                            {\
                                                                                MDrv_SEM_Get_ResourceID(GESEMID, &GE_GetHWSemaphoreID);\
                                                                                GE_D_DBUG("\33[0;31m [Return While][%s][%d] GE_GetHWSemphoreID=%tx, u32GESEMID=%tx, s32GELock=0x%tx\33[m;\n",__FUNCTION__,__LINE__, (ptrdiff_t)GE_GetHWSemaphoreID, (ptrdiff_t)pGECtxLocal->u32GESEMID,pGECtxLocal->s32GELock);\
                                                                                GE_HWSemaphore_count =0;\
                                                                            }\
                                                                         }\
                                                                     }\
...
GE_Result MDrv_GE_Init(void* pInstance, GE_Config *cfg, GE_Context **ppGECtx)
{
    ...
    *ppGECtx = (GE_Context *)pGECtxLocal;
    ...
    GE_Free_Resource(*ppGECtx, FALSE);
    return E_GE_OK;
}
