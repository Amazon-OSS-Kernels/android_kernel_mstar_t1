...
#undef DEF_HDCP22_KS_SIZE
            ...
            case E_HDMITX_CMD_COLOR_AND_RANGE_TRANSFORM:
            {
                ...
                #endif
                ulReturnValue = UADPBypassIoctl(pInstanceTmp, u32Cmd, pArgs, spt_HDMITX_COLORRANGE_TRANSFORM, NULL, usbuffer_arg, sizeof(usbuffer_arg));
            }
            break;
            ...
            case E_HDMITX_CMD_SSC_ENABLE:
            {
                ...
                #endif
                ulReturnValue = UADPBypassIoctl(pInstanceTmp, u32Cmd, pArgs, spt_HDMITX_SETSSCENABLE, NULL, usbuffer_arg, sizeof(usbuffer_arg));
            }
            break;
            ...
            case E_HDMITX_CMD_SET_COLORIMETRY:
            {
                ...
                #endif
                ulReturnValue = UADPBypassIoctl(pInstanceTmp, u32Cmd, pArgs, spt_HDMITX_SETCOLORIMETRY, NULL, usbuffer_arg, sizeof(usbuffer_arg));
            }
            break;
            ...
            case E_HDMITX_CMD_GET_FULL_RX_STATUS:
            {
                ...
                printk("E_HDMITX_CMD_SETCOLORIMETRY\r\n");
                #endif
                ulReturnValue = UADPBypassIoctl(pInstanceTmp, u32Cmd, pArgs, spt_HDMITX_GET_FULL_RX_STATUS, NULL, usbuffer_arg, sizeof(usbuffer_arg));
            }
            break;
    };
