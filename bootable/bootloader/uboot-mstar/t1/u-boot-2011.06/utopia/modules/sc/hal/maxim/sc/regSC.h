...
#define REG_TOP_CKG_SM_CA0_EXT              (REG_CLK_GEN_BASE + (0x0000006dUL << 1))
    #define TOP_CKG_SM_CA0_EXT_MASK         BMASK(1:0)
    #define TOP_CKG_SM_CA0_LOAD             BIT(0)
    #define TOP_CKG_SW_SM_CA0_CLK           BIT(1)
#define REG_TOP_CKG_SM_CA0_M                (REG_CLK_GEN_BASE + (0x0000006dUL << 1))
    #define TOP_CKG_SM_CA0_M_MASK           BMASK(15:8)
#define REG_TOP_CKG_SM_CA0_N                (REG_CLK_GEN_BASE + (0x0000006eUL << 1))
