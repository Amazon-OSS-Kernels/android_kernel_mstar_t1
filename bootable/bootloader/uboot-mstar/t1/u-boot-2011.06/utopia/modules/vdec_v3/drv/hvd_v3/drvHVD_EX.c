...
extern HVD_EX_Result _HVD_EX_Init_(MS_U32 u32Id,MS_U32 u32ModeFlag);
...
HVD_EX_Result MDrv_HVD_EX_GetFrmInfo(MS_U32 u32Id, HVD_EX_GetFrmInfoType eType, HVD_EX_FrameInfo * pInfo)
{
    ...
    if (pFrmInfo != NULL)
    {
        ...
        if(pFrmInfo_ext != NULL)
        {
            ...
            pInfo->u16MaxContentLightLevel    = pFrmInfo_ext->u16maxContentLightLevel;
            pInfo->u16MaxPicAverageLightLevel = pFrmInfo_ext->u16maxPicAverageLightLevel;
...
#define SIZE_3K 0xC00
    ...
    #if defined(CHIP_MONACO) || defined(CHIP_MUJI) || defined(CHIP_MONET) || defined(CHIP_MANHATTAN) || defined(CHIP_MESSI) || defined(CHIP_MASERATI) || defined(CHIP_K6) || defined(CHIP_K6LITE)
