...
//------------------------------------------------------------------------------
E_MVD_Result MDrv_MVD_FlushQueue(MS_U32 u32Id, MS_U8 u8FastFlush)
{
    MVD_FUNC_ENTRY();
    MS_U8 u8HalIdx = MVD_GetHalIdx(u32Id);
    HAL_MVD_EnableFastFlush(u8HalIdx,u8FastFlush);
...
#if (defined(CHIP_EDISON) || defined(CHIP_EINSTEIN) || defined(CHIP_NAPOLI) || defined(CHIP_MONACO) || defined(CHIP_MAXIM))
    MVD_CtrlCfg* pstCtrlCfg = HAL_MVD_GetCtrlCfg(u8HalIdx);
    MS_BOOL bRet = FALSE;
