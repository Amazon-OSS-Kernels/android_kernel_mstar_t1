...
//E_VDEC_EX_V2_USER_CMD_SET_TOTALRANGE_BITSTREAMBUFFER
UADP_SDT_NAMEn_DEF(VDEC_EX_TOTALRANGE_BITSTREAMBUFFER,0);
...
MS_U32 VDEC_EX_adp_Init(FUtopiaIOctl* pIoctl)
{
    ...
    UADP_SDT_NAME0(VDEC_EX_TOTALRANGE_BITSTREAMBUFFER,VDEC_EX_TotalBufRange);
    ...
    UADP_SDT_NAME3(VDEC_EX_SET_TOTALRANGE_BITSTREAMBUFFER,VDEC_EX_V2_IO_Param,UADP_SDT_P2N ,StreamID,VDEC_EX_STREAM_V2_ID,UADP_SDT_P2N ,pRet,VDEC_EX_MS_U32,UADP_SDT_P2N ,param[0],VDEC_EX_PTR_TOTALRANGE_BITSTREAMBUFFER);
...
//    UADP_SDT_NAME0(VDEC_EX_FRAME_INFO_EXT,VDEC_EX_FrameInfoExt_v6);
    ...
    //E_VDEC_EX_V2_CMD_GET_FREE_STREAM_ID
    UADP_SDT_NAME6(VDEC_EX_GET_FREE_STREAM_ID,VDEC_EX_V2_IO_Param,UADP_SDT_P2N,StreamID,VDEC_EX_STREAM_V2_ID,UADP_SDT_P2N,pRet,VDEC_EX_MS_U32,UADP_SDT_P2N,param[0],VDEC_EX_STREAM_ID,UADP_SDT_P2N,param[1],VDEC_EX_MS_U32,UADP_SDT_P2N,param[2],VDEC_EX_STREAM_TYPE,UADP_SDT_P2N,param[3],VDEC_EX_CODEC_TYPE);
    //E_VDEC_EX_V2_CMD_INIT
    //=======================================
    ...
    UADP_SDT_NAME3(VDEC_EX_INIT,VDEC_EX_V2_IO_Param,UADP_SDT_P2N ,StreamID,VDEC_EX_STREAM_V2_ID,UADP_SDT_P2N ,pRet,VDEC_EX_MS_U32,UADP_SDT_P2N ,param[0],VDEC_EX_INIT_PARAM);
    //=======================================
    //E_VDEC_EX_V2_CMD_SET_CONTROL
    //E_VDEC_EX_V2_USER_CMD_CHECK_DISPINFO_READY:
    //E_VDEC_EX_V2_USER_CMD_PLAY:
    ...
    //E_VDEC_EX_V2_USER_CMD_RST:
    //E_VDEC_EX_V2_USER_CMD_EXIT:
    UADP_SDT_NAME2(VDEC_EX_IO,VDEC_EX_V2_IO_Param,UADP_SDT_P2N, StreamID,VDEC_EX_STREAM_V2_ID, UADP_SDT_P2N,pRet,VDEC_EX_MS_U32);
    //E_VDEC_EX_V2_USER_CMD_SET_FRC_MODE
    UADP_SDT_NAME3(VDEC_EX_SET_FRC_MODE,VDEC_EX_V2_IO_Param,UADP_SDT_P2N ,StreamID,VDEC_EX_STREAM_V2_ID,UADP_SDT_P2N ,pRet,VDEC_EX_MS_U32,UADP_SDT_P2N ,param[0],VDEC_EX_FRC_MODE);
    //E_VDEC_EX_V2_USER_CMD_SET_DYNSCALING_PARAMS
    UADP_SDT_NAME4(VDEC_EX_SET_DYNSCALING_PARAMS,VDEC_EX_V2_IO_Param,UADP_SDT_P2N, StreamID,VDEC_EX_STREAM_V2_ID,UADP_SDT_P2N ,pRet,VDEC_EX_MS_U32,UADP_SDT_P2N, param[0],VDEC_EX_MS_PHY ,UADP_SDT_P2N ,param[1],VDEC_EX_MS_U32);

    //E_VDEC_EX_V2_USER_CMD_SET_DBG_LEVEL
    UADP_SDT_NAME3(VDEC_EX_SET_DBG_LEVEL,VDEC_EX_V2_IO_Param,UADP_SDT_P2N, StreamID,VDEC_EX_STREAM_V2_ID,UADP_SDT_P2N, pRet,VDEC_EX_MS_U32,UADP_SDT_P2N, param[0],VDEC_EX_DBG_LEVEL);
    //E_VDEC_EX_V2_USER_CMD_SET_TRICK_MODE
    UADP_SDT_NAME3(VDEC_EX_SET_TRICK_MODE,VDEC_EX_V2_IO_Param,UADP_SDT_P2N, StreamID,VDEC_EX_STREAM_V2_ID,UADP_SDT_P2N,pRet,VDEC_EX_MS_U32,UADP_SDT_P2N, param[0],VDEC_EX_TRICK_DEC);
    //E_VDEC_EX_V2_USER_CMD_PUSH_DECQ
    UADP_SDT_NAME3(VDEC_EX_PUSH_DECQ,VDEC_EX_V2_IO_Param,UADP_SDT_P2N ,StreamID,VDEC_EX_STREAM_V2_ID,UADP_SDT_P2N ,pRet,VDEC_EX_MS_U32,UADP_SDT_P2N ,param[0],VDEC_EX_DEC_CMD);

    //E_VDEC_EX_V2_USER_CMD_FLUSH
    UADP_SDT_NAME3(VDEC_EX_FLUSH,VDEC_EX_V2_IO_Param, UADP_SDT_P2N ,StreamID,VDEC_EX_STREAM_V2_ID, UADP_SDT_P2N ,pRet,VDEC_EX_MS_U32, UADP_SDT_P2N, param[0],VDEC_EX_FREEZE_PIC_SELECT);
    //E_VDEC_EX_V2_USER_CMD_ENABLE_LAST_FRAME_SHOW:
    //E_VDEC_EX_V2_USER_CMD_SET_FREEZE_DISP:
    //E_VDEC_EX_V2_USER_CMD_SET_BLUE_SCREEN:
    //E_VDEC_EX_V2_USER_CMD_DISABLE_DEBLOCKING:
    ...
    //E_VDEC_EX_V2_USER_CMD_SET_BLOCK_DISPLAY:
    //E_VDEC_EX_V2_USER_CMD_ENABLE_ES_BUFF_MALLOC:
    UADP_SDT_NAME3(VDEC_EX_IO_BOOL,VDEC_EX_V2_IO_Param, UADP_SDT_P2N, StreamID,VDEC_EX_STREAM_V2_ID, UADP_SDT_P2N, pRet,VDEC_EX_MS_U32, UADP_SDT_P2N, param[0],VDEC_EX_BOOL);
    //E_VDEC_EX_V2_USER_CMD_SET_SPEED
    UADP_SDT_NAME4(VDEC_EX_SET_SPEED,VDEC_EX_V2_IO_Param,UADP_SDT_P2N ,StreamID,VDEC_EX_STREAM_V2_ID, UADP_SDT_P2N, pRet,VDEC_EX_MS_U32, UADP_SDT_P2N,param[0],VDEC_EX_SPEED_TYPE,UADP_SDT_P2N ,param[1],VDEC_EX_SPEED);
    //E_VDEC_EX_V2_USER_CMD_RESET_PTS:
    //E_VDEC_EX_V2_USER_CMD_AVSYNC_FREERUN_THRESHOLD:
    //E_VDEC_EX_V2_USER_CMD_SEEK_TO_PTS:
    //E_VDEC_EX_V2_USER_CMD_SKIP_TO_PTS:
    //E_VDEC_EX_V2_USER_CMD_CC_INIT;
    UADP_SDT_NAME3(VDEC_EX_IO_U32,VDEC_EX_V2_IO_Param, UADP_SDT_P2N, StreamID,VDEC_EX_STREAM_V2_ID,UADP_SDT_P2N ,pRet,VDEC_EX_MS_U32,UADP_SDT_P2N ,param[0],VDEC_EX_MS_U32);
    //E_VDEC_EX_V2_USER_CMD_AVSYNC_ON
    UADP_SDT_NAME5(VDEC_EX_AVSYNC_ON,VDEC_EX_V2_IO_Param,UADP_SDT_P2N ,StreamID,VDEC_EX_STREAM_V2_ID,UADP_SDT_P2N, pRet,VDEC_EX_MS_U32,UADP_SDT_P2N ,param[0],VDEC_EX_BOOL,UADP_SDT_P2N, param[1],VDEC_EX_MS_U32,UADP_SDT_P2N ,param[2],VDEC_EX_MS_U16);
    //E_VDEC_EX_V2_USER_CMD_UNSET_EVENT_MULTICALLBACK
    UADP_SDT_NAME6(VDEC_EX_UNSET_EVENT_MULTICALLBACK,VDEC_EX_V2_IO_Param,UADP_SDT_P2N, StreamID,VDEC_EX_STREAM_V2_ID,UADP_SDT_P2N,pRet,VDEC_EX_MS_U32,UADP_SDT_P2N,param[0],VDEC_EX_TYPE,UADP_SDT_P2N,param[1],VDEC_EX_MS_U32,UADP_SDT_P2N,param[2],VDEC_EX_MS_U32,UADP_SDT_P2N,param[3],VDEC_EX_MS_U32);
    //E_VDEC_EX_V2_USER_CMD_SET_BALANCE_BW
    UADP_SDT_NAME6(VDEC_EX_SET_BALANCE_BW,VDEC_EX_V2_IO_Param,UADP_SDT_P2N, StreamID,VDEC_EX_STREAM_V2_ID, UADP_SDT_P2N, pRet,VDEC_EX_MS_U32,UADP_SDT_P2N ,param[0],VDEC_EX_MS_U8, UADP_SDT_P2N, param[1],VDEC_EX_MS_U8,UADP_SDT_P2N ,param[2],VDEC_EX_MS_U8,UADP_SDT_P2N ,param[3],VDEC_EX_MS_U8);
    //E_VDEC_EX_V2_USER_CMD_GEN_PATTERN
    UADP_SDT_NAME5(VDEC_EX_GEN_PATTERN,VDEC_EX_V2_IO_Param,UADP_SDT_P2N ,StreamID,VDEC_EX_STREAM_V2_ID, UADP_SDT_P2N,pRet,VDEC_EX_MS_U32, UADP_SDT_P2N ,param[0],VDEC_EX_PATTERN_TYPE, UADP_SDT_P2N, param[1],VDEC_EX_MS_PHY, UADP_SDT_P2N, param[2],VDEC_EX_MS_U32);
    //E_VDEC_EX_V2_USER_CMD_MHEG_DECODE_IFRAME:
    UADP_SDT_NAME5(VDEC_EX_MHEG_DECODE_IFRAME,VDEC_EX_V2_IO_Param, UADP_SDT_P2N, StreamID,VDEC_EX_STREAM_V2_ID, UADP_SDT_P2N, pRet,VDEC_EX_MS_U32, UADP_SDT_P2N, param[0],VDEC_EX_MS_PHY, UADP_SDT_P2N ,param[1],VDEC_EX_MS_PHY, UADP_SDT_P2N, param[2],VDEC_EX_MS_PHY);
    //E_VDEC_EX_V2_USER_CMD_CC_START_PARSING:
    UADP_SDT_NAME3(VDEC_EX_CC_START_PARSING,VDEC_EX_V2_IO_Param, UADP_SDT_P2N, StreamID,VDEC_EX_STREAM_V2_ID, UADP_SDT_P2N, pRet,VDEC_EX_MS_U32, UADP_SDT_P2N, param[0],VDEC_EX_CC_CONFIG);

    //E_VDEC_EX_V2_USER_CMD_DISPLAY_FRAME:
    UADP_SDT_NAME3(VDEC_EX_DISP_RELEASE_FRAME,VDEC_EX_V2_IO_Param, UADP_SDT_P2N, StreamID,VDEC_EX_STREAM_V2_ID, UADP_SDT_P2N, pRet,VDEC_EX_MS_U32, UADP_SDT_P2N, param[0],VDEC_EX_DISP_FRAME);
    //E_VDEC_EX_V2_USER_CMD_CAPTURE_FRAME
    UADP_SDT_NAME4(VDEC_EX_CAPTURE_FRAME,VDEC_EX_V2_IO_Param, UADP_SDT_P2N, StreamID,VDEC_EX_STREAM_V2_ID, UADP_SDT_P2N, pRet,VDEC_EX_MS_U32, UADP_SDT_P2N, param[0],VDEC_EX_MS_U32, UADP_SDT_P2N, param[1],VDEC_EX_BOOL);
    //E_VDEC_EX_V2_USER_CMD_CC_SET_CFG:
    UADP_SDT_NAME5(VDEC_EX_CC_SET_CFG,VDEC_EX_V2_IO_Param, UADP_SDT_P2N, StreamID,VDEC_EX_STREAM_V2_ID, UADP_SDT_P2N,pRet,VDEC_EX_MS_U32, UADP_SDT_P2N, param[0],VDEC_EX_CC_FORMAT, UADP_SDT_P2N, param[1],VDEC_EX_CC_TYPE, UADP_SDT_P2N, param[2],VDEC_EX_CC_INPUT_PARAM);
    //E_VDEC_EX_V2_USER_CMD_CC_SET_BUFF_START_ADDR
    //E_VDEC_EX_V2_USER_CMD_CC_UPDATE_WRITE_ADDR:
    //E_VDEC_EX_V2_USER_CMD_CC_UPDATE_READ_ADDR:
    UADP_SDT_NAME4(VDEC_EX_CC_UPDATE_ADDR,VDEC_EX_V2_IO_Param,UADP_SDT_P2N ,StreamID,VDEC_EX_STREAM_V2_ID, UADP_SDT_P2N, pRet,VDEC_EX_MS_U32,UADP_SDT_P2N ,param[0],VDEC_EX_CC_FORMAT, UADP_SDT_P2N,param[1],VDEC_EX_CC_INPUT_PARAM);
    //E_VDEC_EX_V2_USER_CMD_CC_DISABLE_PARSING:
    //E_VDEC_EX_V2_USER_CMD_CC_GET_IS_RST_DONE
    UADP_SDT_NAME3(VDEC_EX_CC_IO_CC_FORMAT,VDEC_EX_V2_IO_Param,UADP_SDT_P2N ,StreamID,VDEC_EX_STREAM_V2_ID,UADP_SDT_P2N ,pRet,VDEC_EX_MS_U32,UADP_SDT_P2N ,param[0],VDEC_EX_CC_FORMAT);
    //E_VDEC_EX_V2_USER_CMD_GETLIBVER:
    UADP_SDT_NAME3(VDEC_EX_GET_LIBVER,VDEC_EX_V2_IO_Param, UADP_SDT_P2N, StreamID,VDEC_EX_STREAM_V2_ID,UADP_SDT_P2N ,pRet,VDEC_EX_MS_U32, UADP_SDT_P2N, param[0],VDEC_EX_MSIF_VERSION);
    //E_VDEC_EX_V2_USER_CMD_GETINFO:
    UADP_SDT_NAME3(VDEC_EX_GET_INFO,VDEC_EX_V2_IO_Param,UADP_SDT_P2N ,StreamID,VDEC_EX_STREAM_V2_ID,UADP_SDT_P2N ,pRet,VDEC_EX_MS_U32, UADP_SDT_P2N, param[0],VDEC_EX_MS_U32);

    //E_VDEC_EX_V2_USER_CMD_CHECKCAPS
    UADP_SDT_NAME4(VDEC_EX_CHECK_CAPS,VDEC_EX_V2_IO_Param,UADP_SDT_P2N ,StreamID,VDEC_EX_STREAM_V2_ID, UADP_SDT_P2N,pRet,VDEC_EX_MS_U32,UADP_SDT_P2N ,param[0],VDEC_EX_CODEC_TYPE, UADP_SDT_P2N, param[1],VDEC_EX_BOOL);
    //E_VDEC_EX_V2_USER_CMD_GET_ACTIVE_CODEC_TYPE
    UADP_SDT_NAME3(VDEC_EX_GET_ACTIVE_CODEC_TYPE,VDEC_EX_V2_IO_Param,UADP_SDT_P2N ,StreamID,VDEC_EX_STREAM_V2_ID,UADP_SDT_P2N ,pRet,VDEC_EX_MS_U32,UADP_SDT_P2N ,param[0],VDEC_EX_CODEC_TYPE);
    //E_VDEC_EX_V2_USER_CMD_GET_DISP_INFO:
    UADP_SDT_NAME3(VDEC_EX_GET_DISP_INFO,VDEC_EX_V2_IO_Param,UADP_SDT_P2N ,StreamID,VDEC_EX_STREAM_V2_ID,UADP_SDT_P2N ,pRet,VDEC_EX_MS_U32,UADP_SDT_P2N ,param[0],VDEC_EX_DISP_INFO);
    //E_VDEC_EX_V2_USER_CMD_GET_EXT_DISP_INFO
    UADP_SDT_NAME3(VDEC_EX_GET_EXT_DISP_INFO,VDEC_EX_V2_IO_Param,UADP_SDT_P2N ,StreamID,VDEC_EX_STREAM_V2_ID,UADP_SDT_P2N ,pRet,VDEC_EX_MS_U32,UADP_SDT_P2N ,param[0],VDEC_EX_EXT_DISP_INFO);
    //E_VDEC_EX_V2_USER_CMD_GET_DEC_FRAME_INFO
    UADP_SDT_NAME3(VDEC_EX_GET_DEC_FRAME_INFO,VDEC_EX_V2_IO_Param,UADP_SDT_P2N, StreamID,VDEC_EX_STREAM_V2_ID, UADP_SDT_P2N,pRet,VDEC_EX_MS_U32,UADP_SDT_P2N ,param[0],VDEC_EX_FRAME_INFO);
    //E_VDEC_EX_V2_USER_CMD_GET_DEC_TIMECODE
    UADP_SDT_NAME3(VDEC_EX_GET_DEC_TIMECODE,VDEC_EX_V2_IO_Param, UADP_SDT_P2N, StreamID,VDEC_EX_STREAM_V2_ID, UADP_SDT_P2N, pRet,VDEC_EX_MS_U32,UADP_SDT_P2N, param[0],VDEC_EX_TIME_CODE);

    //E_VDEC_EX_V2_USER_CMD_GET_COLOUR_PRIMARIES
    UADP_SDT_NAME3(VDEC_EX_IO_U8,VDEC_EX_V2_IO_Param,UADP_SDT_P2N ,StreamID,VDEC_EX_STREAM_V2_ID, UADP_SDT_P2N, pRet,VDEC_EX_MS_U32, UADP_SDT_P2N, param[0],VDEC_EX_MS_U8);
    //E_VDEC_EX_V2_USER_CMD_GET_FW_VERSION
    UADP_SDT_NAME4(VDEC_EX_GET_FW_VERSION,VDEC_EX_V2_IO_Param,UADP_SDT_P2N, StreamID,VDEC_EX_STREAM_V2_ID, UADP_SDT_P2N, pRet,VDEC_EX_MS_U32,UADP_SDT_P2N ,param[0],VDEC_EX_FW_TYPE,UADP_SDT_P2N ,param[1],VDEC_EX_MS_U32);
    //E_VDEC_EX_V2_USER_CMD_GET_VIDEO_PTS_STC_DELTA
    UADP_SDT_NAME3(VDEC_EX_SET_GET_U64,VDEC_EX_V2_IO_Param,UADP_SDT_P2N ,StreamID,VDEC_EX_STREAM_V2_ID,UADP_SDT_P2N ,pRet,VDEC_EX_MS_U32,UADP_SDT_P2N ,param[0],VDEC_EX_MS_U64);
    //E_VDEC_EX_V2_USER_CMD_GET_ERR_CODE
    UADP_SDT_NAME3(VDEC_EX_GET_ERR_CODE,VDEC_EX_V2_IO_Param, UADP_SDT_P2N,StreamID,VDEC_EX_STREAM_V2_ID, UADP_SDT_P2N, pRet,VDEC_EX_MS_U32, UADP_SDT_P2N ,param[0],VDEC_EX_ERR_CODE);
    //E_VDEC_EX_V2_USER_CMD_GET_CC_INFO
    UADP_SDT_NAME4(VDEC_EX_GET_CC_INFO,VDEC_EX_V2_IO_Param,UADP_SDT_P2N, StreamID,VDEC_EX_STREAM_V2_ID, UADP_SDT_P2N ,pRet,VDEC_EX_MS_U32, UADP_SDT_P2N, param[0],VDEC_EX_CC_INFO, UADP_SDT_P2N, param[1],VDEC_EX_MS_U32);

    //E_VDEC_EX_V2_USER_CMD_GET_PATTERN_LEAST_LENGTH
    UADP_SDT_NAME4(VDEC_EX_GET_PATTERN_LEAST_LENGTH,VDEC_EX_V2_IO_Param, UADP_SDT_P2N, StreamID,VDEC_EX_STREAM_V2_ID, UADP_SDT_P2N ,pRet,VDEC_EX_MS_U32, UADP_SDT_P2N ,param[0],VDEC_EX_PATTERN_TYPE, UADP_SDT_P2N, param[1],VDEC_EX_MS_U32);
    //E_VDEC_EX_V2_USER_CMD_GET_ES_BUFF
    UADP_SDT_NAME5(VDEC_EX_GET_ES_BUFF,VDEC_EX_V2_IO_Param, UADP_SDT_P2N, StreamID,VDEC_EX_STREAM_V2_ID,UADP_SDT_P2N ,pRet,VDEC_EX_MS_U32,UADP_SDT_P2N ,param[0],VDEC_EX_MS_U32, UADP_SDT_P2N, param[1],VDEC_EX_MS_U32,UADP_SDT_P2N ,param[2],VDEC_EX_MS_PHY);
    //E_VDEC_EX_V2_USER_CMD_CC_GET_INFO
    UADP_SDT_NAME5(VDEC_EX_CC_GET_INFO,VDEC_EX_V2_IO_Param, UADP_SDT_P2N ,StreamID,VDEC_EX_STREAM_V2_ID, UADP_SDT_P2N ,pRet,VDEC_EX_MS_U32,UADP_SDT_P2N ,param[0],VDEC_EX_CC_FORMAT,UADP_SDT_P2N ,param[1],VDEC_EX_CC_INFO_CMD,UADP_SDT_P2N, param[2],VDEC_EX_MS_U32);
    //E_VDEC_EX_V2_USER_CMD_CC_GET_WRITE_ADDR
    UADP_SDT_NAME4(VDEC_EX_GET_CC_GET_RW_ADDR,VDEC_EX_V2_IO_Param,UADP_SDT_P2N ,StreamID,VDEC_EX_STREAM_V2_ID,UADP_SDT_P2N ,pRet,VDEC_EX_MS_U32,UADP_SDT_P2N ,param[0],VDEC_EX_CC_FORMAT,UADP_SDT_P2N ,param[1],VDEC_EX_MS_PHY);
    //E_VDEC_EX_V2_USER_CMD_FRC_OUTPUT
//    UADP_SDT_NAME3(VDEC_EX_FRC_OUTPUT,VDEC_EX_V2_IO_Param,UADP_SDT_P2N ,StreamID,VDEC_EX_STREAM_V2_ID,UADP_SDT_P2N ,pRet,VDEC_EX_MS_U32,UADP_SDT_P2N ,param[0],VDEC_EX_FRC_OUTPUT_PARAM);
    ...
    UADP_SDT_NAME3(VDEC_EX_FRC_OUTPUT,VDEC_EX_V2_IO_Param,UADP_SDT_P2N ,StreamID,VDEC_EX_STREAM_V2_ID,UADP_SDT_P2N ,pRet,VDEC_EX_MS_U32,UADP_SDT_P2N ,param[0],VDEC_EX_PTR_FRC_OUTPUT_PARAM);
    
    //E_VDEC_EX_V2_USER_CMD_UT_SET_DBG_MODE
    UADP_SDT_NAME3(VDEC_EX_UT_SET_DBG_MODE,VDEC_EX_V2_IO_Param,UADP_SDT_P2N ,StreamID,VDEC_EX_STREAM_V2_ID,UADP_SDT_P2N, pRet,VDEC_EX_MS_U32,UADP_SDT_P2N ,param[0],VDEC_EX_DBG_MODE);
    //E_VDEC_EX_V2_USER_CMD_FIELD_POLARITY_DISPLAY_ONE_FIELD
    UADP_SDT_NAME3(VDEC_EX_FIELD_POLARITY_DISPLAY_ONE_FIELD,VDEC_EX_V2_IO_Param,UADP_SDT_P2N ,StreamID,VDEC_EX_STREAM_V2_ID,UADP_SDT_P2N ,pRet,VDEC_EX_MS_U32,UADP_SDT_P2N ,param[0],VDEC_EX_FIELD_POLARITY);
    //E_VDEC_EX_V2_USER_CMD_SET_EXTERNAL_DS_BUFFER
    UADP_SDT_NAME3(VDEC_EX_SET_EXTERNAL_DS_BUFFER,VDEC_EX_V2_IO_Param,UADP_SDT_P2N ,StreamID,VDEC_EX_STREAM_V2_ID,UADP_SDT_P2N ,pRet,VDEC_EX_MS_U32,UADP_SDT_P2N ,param[0],VDEC_EX_EXTERNAL_DS_BUF);
    ...
    UADP_SDT_NAME3(VDEC_EX_ENABLE_DECODE_ENGINE_TIMEOUT,VDEC_EX_V2_IO_Param,UADP_SDT_P2N ,StreamID,VDEC_EX_STREAM_V2_ID,UADP_SDT_P2N ,pRet,VDEC_EX_MS_U32,UADP_SDT_P2N ,param[0],VDEC_EX_PTR_TIMEOUT_PARAM);
    //E_VDEC_EX_V2_USER_CMD_SET_ERROR_TOLERANCE
//    UADP_SDT_NAME3(VDEC_EX_SET_ERROR_TOLERANCE,VDEC_EX_V2_IO_Param,UADP_SDT_P2N, StreamID,VDEC_EX_STREAM_V2_ID,UADP_SDT_P2N, pRet,VDEC_EX_MS_U32,UADP_SDT_P2N, param[0],VDEC_EX_ERR_TOLERANCE);
    ...
    UADP_SDT_NAME3(VDEC_EX_SET_ERROR_TOLERANCE,VDEC_EX_V2_IO_Param,UADP_SDT_P2N, StreamID,VDEC_EX_STREAM_V2_ID,UADP_SDT_P2N, pRet,VDEC_EX_MS_U32,UADP_SDT_P2N, param[0],VDEC_EX_PTR_ERR_TOLERANCE);
    
    //E_VDEC_EX_V2_USER_CMD_GET_MAIN_STREAM_ID
    UADP_SDT_NAME3(VDEC_EX_GET_STREAM_ID,VDEC_EX_V2_IO_Param,UADP_SDT_P2N, StreamID,VDEC_EX_STREAM_V2_ID,UADP_SDT_P2N ,pRet,VDEC_EX_MS_U32,UADP_SDT_P2N ,param[0],VDEC_EX_STREAM_ID);
    //E_VDEC_EX_V2_USER_CMD_GET_FPA_SEI
    UADP_SDT_NAME3(VDEC_EX_GET_FPA_SEI,VDEC_EX_V2_IO_Param,UADP_SDT_P2N ,StreamID,VDEC_EX_STREAM_V2_ID,UADP_SDT_P2N ,pRet,VDEC_EX_MS_U32, UADP_SDT_P2N, param[0],VDEC_EX_FRAME_PACKING_SIE);
    //E_VDEC_EX_V2_USER_CMD_GET_FPA_SEI_EX
    UADP_SDT_NAME3(VDEC_EX_GET_FPA_SEI_EX,VDEC_EX_V2_IO_Param,UADP_SDT_P2N ,StreamID,VDEC_EX_STREAM_V2_ID, UADP_SDT_P2N, pRet,VDEC_EX_MS_U32, UADP_SDT_P2N, param[0],VDEC_EX_VER_CTRL);
    //E_VDEC_EX_V2_USER_CMD_GET_CRC_VALUE
    UADP_SDT_NAME3(VDEC_EX_GET_CRC_VALUE,VDEC_EX_V2_IO_Param,UADP_SDT_P2N, StreamID,VDEC_EX_STREAM_V2_ID,UADP_SDT_P2N, pRet,VDEC_EX_MS_U32, UADP_SDT_P2N ,param[0],VDEC_EX_CRC_VALUE);
    //E_VDEC_EX_V2_USER_CMD_GET_FRAME_INFO_EX:
    UADP_SDT_NAME3(VDEC_EX_GET_FRAME_INFO_EX,VDEC_EX_V2_IO_Param,UADP_SDT_P2N ,StreamID,VDEC_EX_STREAM_V2_ID, UADP_SDT_P2N,pRet,VDEC_EX_MS_U32,UADP_SDT_P2N ,param[0],VDEC_EX_FRAME_INFO_EX);
    //E_VDEC_EX_V2_USER_CMD_GET_NEXT_DISP_FRAME_INFO_EXT:
    ...
    #ifdef VDEC_CAP_FRAME_INFO_EXT_V6
        UADP_SDT_NAME3(VDEC_EX_GET_FRAME_INFO_V6,VDEC_EX_V2_IO_Param,UADP_SDT_P2N ,StreamID,VDEC_EX_STREAM_V2_ID,UADP_SDT_P2N, pRet,VDEC_EX_MS_U32,UADP_SDT_P2N ,param[0],VDEC_EX_FRAME_INFO_V6);
    #endif
    #ifdef VDEC_CAP_FRAME_INFO_EXT_V5
        UADP_SDT_NAME3(VDEC_EX_GET_FRAME_INFO_V5,VDEC_EX_V2_IO_Param,UADP_SDT_P2N ,StreamID,VDEC_EX_STREAM_V2_ID,UADP_SDT_P2N, pRet,VDEC_EX_MS_U32,UADP_SDT_P2N ,param[0],VDEC_EX_FRAME_INFO_V5);
    #endif
    #ifdef VDEC_CAP_FRAME_INFO_EXT_V4
        UADP_SDT_NAME3(VDEC_EX_GET_FRAME_INFO_V4,VDEC_EX_V2_IO_Param,UADP_SDT_P2N ,StreamID,VDEC_EX_STREAM_V2_ID,UADP_SDT_P2N, pRet,VDEC_EX_MS_U32,UADP_SDT_P2N ,param[0],VDEC_EX_FRAME_INFO_V4);
    #endif
    #ifdef VDEC_CAP_HEVC_HDR_V3
        UADP_SDT_NAME3(VDEC_EX_GET_FRAME_INFO_V3,VDEC_EX_V2_IO_Param,UADP_SDT_P2N ,StreamID,VDEC_EX_STREAM_V2_ID,UADP_SDT_P2N, pRet,VDEC_EX_MS_U32,UADP_SDT_P2N ,param[0],VDEC_EX_FRAME_INFO_V3);
    #endif
    #ifdef VDEC_CAP_HEVC_HDR_V2
        UADP_SDT_NAME3(VDEC_EX_GET_FRAME_INFO_V2,VDEC_EX_V2_IO_Param,UADP_SDT_P2N ,StreamID,VDEC_EX_STREAM_V2_ID,UADP_SDT_P2N, pRet,VDEC_EX_MS_U32,UADP_SDT_P2N ,param[0],VDEC_EX_FRAME_INFO_V2);
    #endif
        UADP_SDT_NAME3(VDEC_EX_GET_FRAME_INFO_V0,VDEC_EX_V2_IO_Param,UADP_SDT_P2N ,StreamID,VDEC_EX_STREAM_V2_ID,UADP_SDT_P2N, pRet,VDEC_EX_MS_U32,UADP_SDT_P2N ,param[0],VDEC_EX_FRAME_INFO_V0);

    //E_VDEC_EX_V2_USER_CMD_PREGETSTATUS
    UADP_SDT_NAME3(VDEC_EX_PREGETSTATUS,VDEC_EX_V2_IO_Param,UADP_SDT_P2N, StreamID,VDEC_EX_STREAM_V2_ID,UADP_SDT_P2N ,pRet,VDEC_EX_MS_U32,UADP_SDT_P2N ,param[0],VDEC_EX_STATUS);
    //E_VDEC_EX_V2_USER_CMD_SYSTEM_PRESET_VPU_CLOCK
    UADP_SDT_NAME3(VDEC_EX_SYSTEM_PRESET_CLOCK,VDEC_EX_V2_IO_Param,UADP_SDT_P2N ,StreamID,VDEC_EX_STREAM_V2_ID, UADP_SDT_P2N ,pRet,VDEC_EX_MS_U32,UADP_SDT_P2N ,param[0],VDEC_EX_CLOCK_SPEED);
    //E_VDEC_EX_V2_USER_CMD_SETPOWERSTATE
    UADP_SDT_NAME3(VDEC_EX_SET_POWERSTATE,VDEC_EX_V2_IO_Param,UADP_SDT_P2N ,StreamID,VDEC_EX_STREAM_V2_ID,UADP_SDT_P2N ,pRet,VDEC_EX_MS_U32,UADP_SDT_P2N ,param[0],VDEC_EX_POWER_MODE);
    //E_VDEC_EX_V2_USER_CMD_PRESET_DECODE_MODE

    UADP_SDT_NAME1(VDEC_EX_PTR_DEC_MOD_CFG,VDEC_EX_PtrDecModCfg,UADP_SDT_P2N ,pVDEC_EX_DecModCfg,VDEC_EX_DEC_MOD_CFG);
    UADP_SDT_NAME3(VDEC_EX_PRESET_DECODE_MODE,VDEC_EX_V2_IO_Param,UADP_SDT_P2N ,StreamID,VDEC_EX_STREAM_V2_ID,UADP_SDT_P2N ,pRet,VDEC_EX_MS_U32,UADP_SDT_P2N ,param[0],VDEC_EX_PTR_DEC_MOD_CFG);
    //E_VDEC_EX_V2_USER_CMD_HVD_IAPGN_BUF_SHARE_BW_MODE
    ...
    UADP_SDT_NAME3(VDEC_EX_HVD_IAPGN_BUF_SHARE_BW_MODE,VDEC_EX_V2_IO_Param,UADP_SDT_P2N ,StreamID,VDEC_EX_STREAM_V2_ID,UADP_SDT_P2N ,pRet,VDEC_EX_MS_U32,UADP_SDT_P2N ,param[0],VDEC_EX_PTR_IAP_GnBufShareBWMode);
    //E_VDEC_EX_V2_USER_CMD_GET_EVENT_FLAG
    UADP_SDT_NAME4(VDEC_EX_GET_EVENT_FLAG,VDEC_EX_V2_IO_Param,UADP_SDT_P2N ,StreamID,VDEC_EX_STREAM_V2_ID,UADP_SDT_P2N ,pRet,VDEC_EX_MS_U32,UADP_SDT_P2N, param[0],VDEC_EX_MS_U32,UADP_SDT_P2N ,param[1],VDEC_EX_MS_U32);
    ...
    UADP_SDT_NAME3(VDEC_EX_SET_FRAMEBUFF2,VDEC_EX_V2_IO_Param,UADP_SDT_P2N ,StreamID,VDEC_EX_STREAM_V2_ID,UADP_SDT_P2N ,pRet,VDEC_EX_MS_U32,UADP_SDT_P2N ,param[0],VDEC_EX_PTR_FRAMEBUFF);

    //E_VDEC_EX_V2_USER_CMD_SET_DV_XC_SHM_ADDR:
    UADP_SDT_NAME1(VDEC_EX_XC_SHM_ADDR,VDEC_EX_PtrXcShmAddr,UADP_SDT_P2N ,pXCShmAddr,VDEC_EX_MS_PHY);
    UADP_SDT_NAME3(VDEC_EX_SET_DV_XC_SHM_ADDR,VDEC_EX_V2_IO_Param, UADP_SDT_P2N, StreamID,VDEC_EX_STREAM_V2_ID, UADP_SDT_P2N, pRet,VDEC_EX_MS_U32, UADP_SDT_P2N, param[0],VDEC_EX_XC_SHM_ADDR);
