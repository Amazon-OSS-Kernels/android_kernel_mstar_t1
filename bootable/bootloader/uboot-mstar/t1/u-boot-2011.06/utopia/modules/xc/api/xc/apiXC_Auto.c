...
/*!
    1. RGB mode, full scaleÁÙ¬Oºû«ù10bit 1023³o­Ócode, ©Ò¥Hgain ÁÙ¬O®Õ¥¿¨ìÅª¨ì0.5/0.7*1023.
       Offset¤]¬O®Õ¥¿¨ì 0³o­Ócode, RGB¤T­Óchannel ³£¤@¼Ë.
    2. YCbCr mode, ½Ð±NYªºfull scale§ï¦¨10bit code ¬O(235-16)*4, Cb/Cr full scale §ï¦¨10bit (240-16)*4.
       ©Ò¥HY gain­È­n½Õ¨ì¨Ï digital code ¬Ý¨ì 0.5/0.7*(235-16)*4, Cb/Cr«h¬O0.5/0.7*(240-16)*4.
       Offset «h¬O±N Y ¸û·Ç¨ì64 (10bit), Cb/Cr ¨ì512 (10bit).
*/
