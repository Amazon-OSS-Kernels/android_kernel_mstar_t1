...
void Hal_ACE_SetPostRGBGain(void *pInstance, MS_BOOL bScalerWin, MS_U16 u16RedGain, MS_U16 u16GreenGain, MS_U16 u16BlueGain)
{
    if(MApi_XC_MLoad_GetStatus_U2(pInstance) == E_MLOAD_ENABLED)
    {
        ...
        {
            MApi_XC_MLoad_WriteCmd(pInstance, REG_SC_BK25_24_L, u16RedGain, 0x1FFF);
            MApi_XC_MLoad_WriteCmd(pInstance, REG_SC_BK25_25_L, u16GreenGain, 0x1FFF);
            MApi_XC_MLoad_WriteCmd(pInstance, REG_SC_BK25_26_L, u16BlueGain, 0x1FFF);
            MApi_XC_MLoad_WriteCmd(pInstance, REG_SC_BK25_01_L, BIT(6) | BIT(5) | BIT(4), BIT(6) | BIT(5) | BIT(4));
        }
        else
        {
            MApi_XC_MLoad_WriteCmd(pInstance, REG_SC_BK25_2A_L, u16RedGain, 0x1FFF);
            MApi_XC_MLoad_WriteCmd(pInstance, REG_SC_BK25_2B_L, u16GreenGain, 0x1FFF);
            MApi_XC_MLoad_WriteCmd(pInstance, REG_SC_BK25_2C_L, u16BlueGain, 0x1FFF);
            MApi_XC_MLoad_WriteCmd(pInstance, REG_SC_BK25_11_L, BIT(6) | BIT(5) | BIT(4), BIT(6) | BIT(5) | BIT(4));
        }
        MApi_XC_MLoad_Fire(pInstance, TRUE);
    }
    else
                                          ...
                                          MS_U16 u16RedOffset, MS_U16 u16GreenOffset, MS_U16 u16BlueOffset)
{
     if(MApi_XC_MLoad_GetStatus_U2(pInstance) == E_MLOAD_ENABLED)
     {
         if(MAIN_WINDOW == bScalerWin)
         {
            MApi_XC_MLoad_WriteCmd(pInstance, REG_SC_BK25_21_L, u16RedOffset, 0x1FFF);
            MApi_XC_MLoad_WriteCmd(pInstance, REG_SC_BK25_22_L, u16GreenOffset, 0x1FFF);
            MApi_XC_MLoad_WriteCmd(pInstance, REG_SC_BK25_23_L, u16BlueOffset, 0x1FFF);
            MApi_XC_MLoad_WriteCmd(pInstance, REG_SC_BK25_24_L, u16RedGain, 0x1FFF);
            MApi_XC_MLoad_WriteCmd(pInstance, REG_SC_BK25_25_L, u16GreenGain, 0x1FFF);
            MApi_XC_MLoad_WriteCmd(pInstance, REG_SC_BK25_26_L, u16BlueGain, 0x1FFF);
            MApi_XC_MLoad_WriteCmd(pInstance, REG_SC_BK25_01_L, BIT(6) | BIT(5) | BIT(4), BIT(6) | BIT(5) | BIT(4));
         ...
         {
            MApi_XC_MLoad_WriteCmd(pInstance, REG_SC_BK25_27_L, u16RedOffset, 0x1FFF);
            MApi_XC_MLoad_WriteCmd(pInstance, REG_SC_BK25_28_L, u16GreenOffset, 0x1FFF);
            MApi_XC_MLoad_WriteCmd(pInstance, REG_SC_BK25_29_L, u16BlueOffset, 0x1FFF);
            MApi_XC_MLoad_WriteCmd(pInstance, REG_SC_BK25_2A_L, u16RedGain, 0x1FFF);
            MApi_XC_MLoad_WriteCmd(pInstance, REG_SC_BK25_2B_L, u16GreenGain, 0x1FFF);
            MApi_XC_MLoad_WriteCmd(pInstance, REG_SC_BK25_2C_L, u16BlueGain, 0x1FFF);
            MApi_XC_MLoad_WriteCmd(pInstance, REG_SC_BK25_11_L, BIT(6) | BIT(5) | BIT(4), BIT(6) | BIT(5) | BIT(4));
