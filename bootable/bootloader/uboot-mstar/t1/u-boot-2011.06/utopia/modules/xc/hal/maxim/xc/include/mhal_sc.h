...
#define H_PreScalingDownRatio_SC1(Input, Output)                { u64_result = ((MS_U64)(Output))    * 1048576ul;do_div(u64_result,(Input));     u64_result +=1;}
#define H_PreScalingDownRatioAdv_SC1(Input, Output)             { u64_result = ((MS_U64)(Input)-1)   * 1048576ul;do_div(u64_result,(Output-1)); } //Advance scaling
#define H_PreScalingDownRatioAdv_No_Minus1_SC1(Input, Output)   { u64_result = ((MS_U64)(Input))     * 1048576ul;do_div(u64_result,(Output));}   //Advance scaling without minus 1
#endif
...
#define H_PostScalingUpPhase(Input, Output)                 { u64_Phaseresult = ((MS_U64)(Input))     * 1048576ul;do_div(u64_Phaseresult,(Output));    u64_Phaseresult +=1048576ul; u64_Phaseresult +=1;do_div(u64_Phaseresult,2);}
#define H_PostScalingDownPhase(Input, Output)               { u64_Phaseresult = ((MS_U64)(Input))     * 1048576ul;do_div(u64_Phaseresult,(Output));    u64_Phaseresult =1048576ul - u64_Phaseresult; u64_Phaseresult +=1;do_div(u64_Phaseresult,2);}
#define V_PostScalingRatio(Input, Output)                 { u64_result = ((MS_U64)(Input))     * 2097152ul;do_div(u64_result,(Output));    u64_result +=1;do_div(u64_result,2);}
#define V_PostScalingRatio_P2I(Input, Output)               { u64_result = ((MS_U64)(Input))     * 2097152ul;do_div(u64_result,(Output*2));}
#define V_PostScalingUpPhase(Input, Output)                 { u64_Phaseresult = ((MS_U64)(Input))     * 1048576ul;do_div(u64_Phaseresult,(Output));    u64_Phaseresult +=1048576ul; u64_Phaseresult +=1;do_div(u64_Phaseresult,2);}
#define V_PostScalingDownPhase(Input, Output)               { u64_Phaseresult = ((MS_U64)(Input))     * 1048576ul;do_div(u64_Phaseresult,(Output));    u64_Phaseresult =u64_Phaseresult - 1048576ul; u64_Phaseresult +=1;do_div(u64_Phaseresult,2);}
#else
...
#if PIP_PATCH_USING_SC1_MAIN_AS_SC0_SUB
#define H_PreScalingDownRatio_SC1(Input, Output)                ( (((MS_U32)(Output)) * 1048576ul)/ (Input) + 1 )
#define H_PreScalingDownRatioAdv_SC1(Input, Output)             ( (((MS_U32)(Input)-1) * 1048576ul)/ ((Output)-1) ) //Advance scaling
#define H_PreScalingDownRatioAdv_No_Minus1_SC1(Input, Output)   ( (((MS_U32)(Input)) * 1048576ul)/ ((Output)) )     //Advance scaling without minus 1
#endif
...
#define H_PostScalingUpPhase(Input, Output)        ((MS_U32)( 1048576ul + ((MS_U64)(Input)) * 1048576ul / (Output) + 1 )/2 )
#define H_PostScalingDownPhase(Input, Output)        ((MS_U32)( ((MS_U64)(Input)) * 1048576ul / (Output) - 1048576ul + 1 )/2 )
...
#define V_PostScalingUpPhase(Input, Output)        ((MS_U32)( 1048576ul + ((MS_U64)(Input)) * 1048576ul / (Output) + 1 )/2 )
#define V_PostScalingDownPhase(Input, Output)        ((MS_U32)( ((MS_U64)(Input)) * 1048576ul / (Output) - 1048576ul + 1 )/2 )
...
// Decide DLC CaptureRange
#ifndef DLC_CaptureRange_SIX_OVER_EIGHT
#define DLC_CaptureRange_SIX_OVER_EIGHT 0
#endif
...
#ifdef STELLAR
INTERFACE void Hal_SC_enable_PIP(void *pInstance, MS_BOOL bEn);
INTERFACE void Hal_SC_enable_PIP_burst(void *pInstance, MS_BOOL bEn);
#endif
