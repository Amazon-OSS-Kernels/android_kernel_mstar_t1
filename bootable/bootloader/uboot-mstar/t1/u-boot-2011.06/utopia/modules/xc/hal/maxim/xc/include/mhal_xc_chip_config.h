...
#define FRC_PIPE_DELAY_VCNT_FSC_FHD_HDMITX 0x10
#define FRC_PIPE_DELAY_VCNT_FSC_4K_HDMITX      0x06
...
#define SUPPORTED_KERNEL_INT  ((1UL << SC_INT_VSINT)|(1UL << SC_INT_PWM_RP_R_INT)|(1UL << SC_INT_PWM_FP_R_INT)|(1UL << SC_INT_F2_IPVS_SB))
...
#define SUPPORT_Scaling_Sub1_Mode
...
#define HW_SUPPORT_FRC_DUAL_MIU            TRUE
...
#define DLC_CaptureRange_SIX_OVER_EIGHT 1
