...
void Hal_SC_vop2_Set_TestPattern(void *pInstance,MS_BOOL bEnable, MS_U16 u16R_Data, MS_U16 u16G_Data ,MS_U16 u16B_Data)
{
    ...
    if(bEnable == TRUE)
    {
        if(pXCResourcePrivate->stdrvXC_MVideo.bIsOP2TestPattern == FALSE)
        {
            ...
            pXCResourcePrivate->stdrvXC_MVideo.bIsClampMode = SC_R2BYTEMSK(psXCInstPri->u32DeviceID,REG_SC_BK10_70_L, BIT(0));
            ...
            SC_W2BYTEMSK(psXCInstPri->u32DeviceID,REG_SC_BK10_70_L, 0,BIT(0));
    ...
    else
    {
        ...
        {
            SC_W2BYTEMSK(psXCInstPri->u32DeviceID,REG_SC_BK10_70_L, pXCResourcePrivate->stdrvXC_MVideo.bIsClampMode,BIT(0));
