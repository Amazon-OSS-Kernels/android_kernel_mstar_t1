...
#ifdef STELLAR
UADP_SDT_NAMEn_DEF(DIP_INTER_CB,0);
#endif
...
#endif
UADP_SDT_NAMEn_DEF(DIP_SETCONFIG_A0,0);
UADP_SDT_NAMEn_DEF(DIP_SETCONFIG,1);
...
#ifdef STELLAR
    UADP_SDT_NAME0(DIP_INTER_CB,DIP_INTER_CB);
#endif
    //MDrv_CMD_DIP_TRIGGER,
...
#endif
    UADP_SDT_NAME0(DIP_SETCONFIG_A0,MS_BOOL);
    UADP_SDT_NAME1(DIP_SETCONFIG,DIP_SETCONFIG_PARAM,UADP_SDT_P2N,pCfg,DIP_SETCONFIG_A0);
...
MS_U32 DIP_adp_Ioctl(void* pInstanceTmp, MS_U32 u32Cmd, void* const pArgs)
{
    ...
    switch(u32Cmd)
    {
        ...
        case MDrv_CMD_DIP_INTERRUPT_CB:
            u32Ret=UADPBypassIoctl(pInstanceTmp,u32Cmd,pArgs,SPT(DIP_INTER_CB),SPT(DIP_INTER_CB), buffer_arg,sizeof(buffer_arg));
            break;
#endif
        ...
        case MDrv_CMD_DIP_SET_CONFIG:
            u32Ret=UADPBypassIoctl(pInstanceTmp,u32Cmd,pArgs,SPT(DIP_SETCONFIG),SPT(DIP_SETCONFIG), buffer_arg,sizeof(buffer_arg));
            break;
        default:
            break;
