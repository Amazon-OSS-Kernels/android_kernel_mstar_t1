...
MMFI2_CHIPS = agate einstein eiffel einstein3 keres kirin monaco muji miami monet manhattan messi maserati kano curry k6 maxim
ifeq ($(CHIP), $(filter $(CHIP),$(MMFI2_CHIPS)))
DRV_DIR += mmfi2
endif

CFTV_CHIPS = manhattan maserati
ifeq ($(CHIP), $(filter $(CHIP),$(CFTV_CHIPS)))
DRV_DIR += tcf
endif
...
BOX_CHIPS = u3 u4 k1 k2 kaiser keltic keres kirin kris clippers kano curry k6 k6lite
...
NJPD_CHIPS = agate eagle e3 eiffel edison einstein nike madison miami einstein3 monaco clippers muji monet manhattan messi maserati maxim kano curry k6 k6lite
...
NEW_CA_CHIPS = kaiser keltic keres kirin kano curry k6 k6lite
