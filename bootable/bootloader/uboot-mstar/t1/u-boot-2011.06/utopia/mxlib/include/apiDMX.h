...
typedef enum
{
    E_DMX_CILINK_COMPANION_TO_CARD_CLK_CFG,
    E_DMX_CILINK_COMPANION_FROM_CARD_CLK_CFG,

}DMX_CILINK_CMD;

//CILINK TO/FROM CARD CFG
typedef struct DLL_PACKED
{
    MS_U8                   u8SampleCnt;
    MS_BOOL                 bSampleEnable;
    MS_BOOL                 bClkInv;
    MS_BOOL                 bSet;
}DMX_CILINK_ClkCfg;
...
//-------------------------------------------------------------------------------------------------
DMX_FILTER_STATUS SYMBOL_WEAK MApi_DMX_CILINK_Config(DMX_CILINK_ENG eEng,DMX_CILINK_CMD eCmd, void* pData);
//-----------------
// TSP_Merge
//-----------------
//-------------------------------------------------------------------------------------------------
