...
ifeq ($(CONFIG_UTOPIA_PROC_DBG_SUPPORT_USER),y)
CFG_2K_DEFS += -D'CONFIG_UTOPIA_PROC_DBG_SUPPORT_USER'
endif
...
VDEC_SUPPORT_MSVP9 = manhattan maserati kano curry kastor
...
# **********************************************
TSP3_CHIPS = eiffel monaco miami clippers muji munich manhattan maserati maxim
TSP4_CHIPS = kaiser keltic keres kano kastor
FQ_CHIPS = kappa keltic keres monaco maserati maxim kano kastor
TSO_CHIP = napoli kaiser keres
TSO2_CHIP = monaco miami muji munich manhattan maserati maxim kano kastor
OTV_CHIPS = kris kirin kano kastor
...
ifeq ($(CONFIG_KERN_3_10_40),y)
KERNELDIR ?= ../../../RedLion_develop/3.10.86_linaro_stable/3.10.86/
else ifeq ($(CONFIG_KERN_3_10_86),y)
KERNELDIR ?= ../../../RedLion_develop/3.10.86_linaro_stable/3.10.86/
else
KERNELDIR ?= ../../../RedLion/3.10.23/
endif
