...
const struct idme_init_values idme_default_values[] = {
...
#endif
	{ { "mac_addr2", 16, 1, 0444 },
		/* Default 2nd MAC address */
		"0"
        },
	{ { "led_dt_prop", 256, 1, 0444 },
		/* LED device tree properties */
		""
        },
	{ { "accel_cal", 64, 1, 0444 },
	...
	{ { "spk_gain_trim.0", 16, 1, 0444 },
		/* Speaker Gain Trim Calibration Data */
		""
	},
	{ { "", 0, 0, 0 }, 0 },
};
