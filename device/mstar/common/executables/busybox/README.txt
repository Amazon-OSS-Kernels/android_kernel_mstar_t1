Busybox:
Source Code: downloaded from busybox.net
Version: 1.19.2
Toolchain: arm-2010.09/bin/arm-none-linux-gnueabi-
Compilation method: dynamic link
The busybox contains these commands as follows:
...
(you can get more information from busybox.net)