...
typedef enum {
     ...
     DSDESC_ALL          = 0x000077FF   /* all of these */
...
typedef enum {
    GFXDRAW_FLAG_DEFAULT        = 0x0,
    GFXDRAW_FLAG_SCALE          = 0x1,
    GFXDRAW_FLAG_DUPLICAPE      = 0x2,
    GFXDRAW_FLAG_TRAPEZOID_X    = 0x4,
    GFXDRAW_FLAG_TRAPEZOID_Y    = 0x8,
}DFBGfxDrawFlags;
