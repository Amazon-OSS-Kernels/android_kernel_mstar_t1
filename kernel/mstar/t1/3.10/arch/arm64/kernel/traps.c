...
static void dump_call_trace(struct pt_regs *regs, struct task_struct *tsk)
{
	struct stackframe frame;
...
void show_call_trace(struct task_struct *tsk, unsigned long *sp)
{
	dump_call_trace(NULL, tsk);
	barrier();
}
