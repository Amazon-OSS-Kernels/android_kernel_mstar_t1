...
#define GOP_MIU_RESUME_CLIENT(x) ((GOP_MIU_CLIENT) & (~(BIT(x+5))))
#define GOP_MIU_RESUME_GOP_CLIENT(x) (BIT(x+5))
#define GFLIP_REG_PRE_BANK31(x) ((3*x))
#define GFLIP_REG_PRE_BANK32(x) ((3*x+1))
#define GFLIP_REG_PRE_BANK33(x) ((3*x+2))
//
...
/*
 * GFLIP related MIU Arbitor Defines
 */
