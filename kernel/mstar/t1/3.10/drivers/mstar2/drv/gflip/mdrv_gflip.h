...
typedef void (*FP_CFD_GOP_PreSDR)(const STU_CFDAPI_TOP_CONTROL_GOP *pstu_Cfd_api_top, STU_CFDAPI_GOP_PREPROCESS_OUT *pst_Cfd_api_out);
...
INTERFACE MS_BOOL MDrv_GFLIP_Resume_GOP(MS_U32 u32GopIdx);
INTERFACE MS_BOOL MDrv_GFLIP_Register_CB(MS_U8 u8Type, void *fpCB);
