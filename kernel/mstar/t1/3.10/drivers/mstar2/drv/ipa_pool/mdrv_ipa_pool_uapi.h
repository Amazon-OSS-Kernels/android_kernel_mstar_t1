...
struct IPA_Pool_Init_Args
{
    ...
    MS_U64 offset_in_heap;    //in: pool location in heap address space
...
struct PA_In_IPA_Pool_Args
{
    ...
    enum IPA_HEAP_TYPE space_type;//out: return space type to application
...
#define IPA_POOL_IOC_PA_INFO   _IOWR(IPA_POOL_IOC_MAGIC, 0x0D, struct PA_In_IPA_Pool_Args)
#define IPA_POOL_IOC_POOL_TO_PA   _IOWR(IPA_POOL_IOC_MAGIC, 0x0E, struct Pool_To_PA_Args)
