...
//=====================================================
  ...
  #include "drvNAND_manhattan_linux.h"
  #elif defined(CONFIG_MSTAR_MASERATI)
  #include "drvNAND_maserati_linux.h"
  #elif defined(CONFIG_MSTAR_MAXIM)
  #include "drvNAND_maxim_linux.h"
  #elif defined(CONFIG_MSTAR_KANO)
  #include "drvNAND_kano_linux.h"
  #elif defined(CONFIG_MSTAR_MALDIVES)
  #include "drvNAND_maldives_linux.h"
  #elif defined(CONFIG_MSTAR_MESSI)
  #include "drvNAND_messi_linux.h"
  #else
