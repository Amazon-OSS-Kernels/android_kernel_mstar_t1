...
static void get_wakeup_reason()
{
	...
	case WKUP_SRC_SAR:
		...
		case KEYPAD_POWER_CODE:
			...
			break;
		case IR_CUSTOM_1_CODE:
			sprintf(power_on_src_name, "%s", "app_1");
			sprintf(wakeup_src_name, "%s", "KEY_CUSTOM_1");
			wakeup_key_code = KEY_CUSTOM_1;
			break;
		case IR_CUSTOM_2_CODE_SEIKI:
		case IR_CUSTOM_2_CODE_PEPPER:
			sprintf(power_on_src_name, "%s", "app_2");
			sprintf(wakeup_src_name, "%s", "KEY_CUSTOM_2");
			wakeup_key_code = KEY_CUSTOM_2;
			break;
		case IR_CUSTOM_3_CODE_SEIKI:
		case IR_CUSTOM_3_CODE_PEPPER:
			sprintf(power_on_src_name, "%s", "app_3");
			sprintf(wakeup_src_name, "%s", "KEY_CUSTOM_3");
			wakeup_key_code = KEY_CUSTOM_3;
			break;
		case IR_WAKEUP_CODE:
			sprintf(power_on_src_name, "%s", "wakeup");
			sprintf(wakeup_src_name, "%s", "IR_KEY_WAKEP");
			wakeup_key_code = KEY_WAKEUP;
			break;
		default:
	...
	case WKUP_SRC_RTC2:
		...
		break;
	case WKUP_SRC_SPECIAL:
		sprintf(power_on_src_name, "%s", "special_reboot");
		sprintf(wakeup_src_name, "%s", "special_reboot");
		pm_report_wakeup = 1;
		break;
