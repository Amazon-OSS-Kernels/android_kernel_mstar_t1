						...
						u64 *powering_on)
{
	...
	*powering_on = powering_on_trans;
	...
	/* Shader core can outputs glitching on reset on Mali-T series GPU.
	 * This is ARM software workaround, deferring the power down sequecnes
	 * to the platform code. Therefore, power down of shader cores and
	 * core group(tiler, L2) is bypassed.
