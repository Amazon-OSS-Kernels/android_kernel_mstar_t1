...
/* REG_MIU_LEN is set by MIU driver as:
...
#define MHZ_TO_REG(MHZ) (0x6c000000 / MHZ)
    ...
    GPU_REG(REG_GPU_MIU2_START) = (MSTAR_MIU2_BUS_BASE >> 20) & 0xFFFF;
    GPU_REG(REG_GPU_MIU2_END)   = ((MSTAR_MIU2_BUS_BASE >> 20) & 0xFFFF) + (1 << (MIU2_REG(REG_MIU_LEN) >> SHIFT_MIU_LEN));
