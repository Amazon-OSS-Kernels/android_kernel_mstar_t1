...
MS_BOOL KHAL_SC_Set_DynamicScaling(EN_KDRV_SC_DEVICE u32DeviceID,MS_PHY u32MemBaseAddr, MS_U8 u8MIU_Select, MS_U8 u8IdxDepth, MS_BOOL bOP_On, MS_BOOL bIPS_On, MS_BOOL bIPM_On,EN_KDRV_WINDOW eWindow)
{
    MS_U16 u16OnOff = 0;
...
//        && (pXCResourcePrivate->stdrvXC_3D._eInput3DMode[E_KDRV_MAIN_WINDOW] == E_XC_3D_INPUT_MODE_NONE) && (pXCResourcePrivate->stdrvXC_3D._eOutput3DMode == E_XC_3D_OUTPUT_MODE_NONE) ) //abc123:0740226
//        {
