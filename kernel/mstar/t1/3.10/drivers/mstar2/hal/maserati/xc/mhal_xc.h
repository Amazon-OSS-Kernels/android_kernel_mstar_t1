...
typedef enum
{
	...
	E_KDRV_XC_HDR_PATH_NON_HDR_HDMI,
...
{
    /// None HDR
    E_KDRV_XC_CFD_HDR_TYPE_NONE,
    /// Dolby HDR
    E_KDRV_XC_CFD_HDR_TYPE_DOLBY,
    /// Open HDR
    E_KDRV_XC_CFD_HDR_TYPE_OPEN,
    /// Max
...
INTERFACE BOOL MHal_XC_DisableHDMI422To444();
...
INTERFACE BOOL MHal_XC_ConfigHDRAutoDownloadStoredInfo(MS_PHY phyLutBaseAddr, MS_U32 u32Size);
INTERFACE BOOL MHal_XC_StoreHDRAutoDownload(MS_U8* pu8Data, MS_U32 u32Size, void* pParam);
INTERFACE BOOL MHal_XC_WriteStoredHDRAutoDownload(MS_PHY phyLutBaseAddr, MS_U32 u32Size, MS_U8 u8Index,
    MS_PHY *pphyFireAdlAddr, MS_U32 *pu32Depth);
INTERFACE MS_U32 MHal_XC_GetHDRAutoDownloadStoredSize();
...
INTERFACE BOOL MHal_XC_InitHDR();
INTERFACE BOOL MHal_XC_ExitHDR();
INTERFACE MS_U32 MHal_XC_GetRegsetCnt();
INTERFACE void MHal_XC_PrepareDolbyInfo();
