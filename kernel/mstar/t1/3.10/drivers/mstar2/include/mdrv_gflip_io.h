...
#define MDRV_GFLIP_IOC_SETLOGOGOP1_NR  (MDRV_GFLIP_IOC_SETDLCINITINFO_NR+1)
...
#define MDRV_GFLIP_IOC_SETLOGOGOP1     _IOWR(MDRV_GFLIP_IOC_MAGIC , MDRV_GFLIP_IOC_SETLOGOGOP1_NR , MS_U32)
