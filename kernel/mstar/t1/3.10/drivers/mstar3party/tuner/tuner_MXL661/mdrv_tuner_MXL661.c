...
int m_bInATVFinetuneMode;//Add to fix fineTune garbage(abc123 0586666)
U32 u32GlobalATVRfFreqKHz;//Add to fix fineTune garbage(abc123 0586666)
...
int MDrv_TUNER_Connect(int minor)
{
    ...
    m_bDeviceBusy=1;
#endif
    m_bInATVFinetuneMode = MXL_DISABLE; //Add to fix fineTune garbage(abc123 0586666)
    u32GlobalATVRfFreqKHz = 0; //Add to fix fineTune garbage(abc123 0586666)
    u32chantuneFreq = 0;
    return TRUE;
}
...
int MDrv_TUNER_ATV_SetTune(int minor, U32 u32FreqKHz, U32 eBand, U32 eMode, U8 otherMode)
{
    ...
    int fineTuneScaleUp; //Add to fix fineTune garbage(abc123 0586666)
...
int MDrv_TUNER_Resume(void)
{
    ...
    for (i=0; i<MAX_TUNER_DEV_NUM; i++)
    {
        ...
        {
            if (MDrv_TUNER_TunerInit((int)i)==TRUE)
            {
